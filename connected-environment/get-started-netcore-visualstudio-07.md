---
title: Visual Studio - adım 7 - Özet ile bulutta Kubernetes kullanarak kapsayıcılarla .NET Core geliştirme ortamı oluşturma | Microsoft Docs
author: ghogen
ms.author: ghogen
ms.date: 04/05/2018
ms.topic: tutorial
...
Önceki adımda: [takım geliştirme hakkında bilgi edinin](get-started-netcore-visualstudio-06.md)
