...
##### [Normal İfadeleri Kullanma](ide/using-regular-expressions-in-visual-studio.md)
...
#### [VB için IDE’yi kullanma...](vb-ide/refactoring-vb.md)
#### [Yeniden Düzenleme, Kod Oluşturma ve Hızlı Eylemler](ide/refactoring-code-generation-quick-actions.md)
...
##### [EditorConfig için .NET Dil ve Biçimlendirme Kuralları](ide/editorconfig-code-style-settings-reference.md)
...
##### [Sınıfları ve Türleri Tasarlama ve Görüntüleme (Sınıf Tasarımcısı)](ide/class-designer/TOC.md)
...
#### [Başlangıç Paketleri Oluşturma](ide/how-to-create-starter-kits.md)
