...
## [Visual Studio’da Python...](python/vs-tutorial-01-01.md)
...
###### C# için Hızlı Eylemler
####### [Sınıf/tür oluşturma](ide/reference/generate-class-type-csharp.md)
####### [Metot oluşturma](ide/reference/generate-method-csharp.md)
####### [Alan/özellik/yerel öğe oluşturma](ide/reference/generate-field-property-local-csharp.md)
####### [Oluşturucu oluşturma](ide/reference/generate-constructor-csharp.md)
####### [Geçersiz kılma oluşturma](ide/reference/generate-override-csharp.md)
####### [Equals ve GetHashCode metot geçersiz kılmaları oluşturma](ide/reference/generate-overrides-csharp.md)
####### [XML belge açıklamaları oluşturma](ide/reference/generate-xml-documentation-comments-csharp.md)
####### [Soyut sınıf uygulama](ide/reference/implement-abstract-class-csharp.md)
####### [Arabirim uygulama](ide/reference/implement-interface-csharp.md)
####### [Yerel değişken ekleme](ide/reference/introduce-local-variable-csharp.md)
###### Visual Basic için Hızlı Eylemler
####### [Sınıf/Tür Oluşturma](ide/reference/generate-class-type-vb.md)
####### [Üretme Metodu](ide/reference/generate-method-vb.md)
####### [Alan/özellik/yerel öğe oluşturma](ide/reference/generate-field-property-local-vb.md)
####### [Oluşturucu Oluşturma](ide/reference/generate-constructor-vb.md)
####### [Geçersiz Kılma Oluşturma](ide/reference/generate-override-vb.md)
####### [XML Belge Açıklamaları Oluşturma](ide/reference/generate-xml-documentation-comments-vb.md)
####### [Soyut Sınıf Uygulama](ide/reference/implement-abstract-class-vb.md)
####### [Arabirim Uygulama](ide/reference/implement-interface-vb.md)
####### [Yerel Değişken Ekleme](ide/reference/introduce-local-variable-vb.md)
#### [Kodu Yeniden Düzenleme](ide/refactoring-in-visual-studio.md)
##### C# için Yeniden Düzenlemeler
###### [Metot imzasını değiştirme](ide/reference/change-method-signature-csharp.md)
###### [Get metodunu özelliğe dönüştürme](ide/reference/convert-get-method-to-property-csharp.md)
###### [Alanı kapsülleme](ide/reference/encapsulate-field-csharp.md)
###### [Ayıklama arabirimi](ide/reference/extract-interface-csharp.md)
###### [Ayıklama metodu](ide/reference/extract-method-csharp.md)
###### [Satır içi geçici değişken](ide/reference/inline-temporary-variable-csharp.md)
###### [Bildirimi başvurunun yanına taşıma](ide/reference/move-declaration-near-reference-csharp.md)
###### [Türü eşleşen dosyaya taşıma](ide/reference/move-type-to-matching-file-csharp.md)
###### [Erişilemeyen kodları kaldırma](ide/reference/remove-unreachable-code-csharp.md)
###### [Yeniden Adlandır](ide/reference/rename-csharp.md)
###### [Eşitleme türü ve dosya adı](ide/reference/sync-type-and-file-csharp.md)
##### Visual Basic için yeniden düzenlemeler
###### [Metot imzasını değiştirme](ide/reference/change-method-signature-vb.md)
###### [Alanı kapsülleme](ide/reference/encapsulate-field-vb.md)
###### [Ayıklama arabirimi](ide/reference/extract-interface-vb.md)
###### [Ayıklama metodu](ide/reference/extract-method-vb.md)
###### [Satır içi geçici değişken](ide/reference/inline-temporary-variable-vb.md)
###### [Türü eşleşen dosyaya taşı](ide/reference/move-type-to-matching-file-vb.md)
...
##### [İzlenecek Yol: Kullanımdan Üret Özelliği ile Önce Test Desteği](ide/walkthrough-test-first-support-with-the-generate-from-usage-feature.md)
...
## [Proje ve Öğe Şablonları](ide/creating-project-and-item-templates.md)
