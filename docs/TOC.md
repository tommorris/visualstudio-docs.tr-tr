...
## [Düzenleyiciyi kullanma](ide/quickstart-editor.md)
...
### [IDE’de gezinme](ide/how-to-move-around-in-the-visual-studio-ide.md)
...
##### [Uygulama ve dağıtım bildirimlerini imzalama](ide/how-to-sign-application-and-deployment-manifests.md)
#### [Uygulama simgesi belirtme (Visual Basic, C#)](ide/how-to-specify-an-application-icon-visual-basic-csharp.md)
#### [Çoklu sürüm desteğine genel bakış](ide/visual-studio-multi-targeting-overview.md)
...
##### [Bir şablonda parametreleri ikame etme](ide/how-to-substitute-parameters-in-a-template.md)
#### [64 bit desteği](ide/visual-studio-ide-64-bit-support.md)
...
### [Düzenleyiciyi kullanma](ide/writing-code-in-the-code-and-text-editor.md)
#### [Metin bulma ve değiştirme](ide/finding-and-replacing-text.md)
##### [Normal ifadeler kullanma](ide/using-regular-expressions-in-visual-studio.md)
...
####### [En iyi uygulamalar](ide/best-practices-for-using-code-snippets.md)
...
###### [For döngüsü ve foreach deyimi arasında dönüştürme](ide/reference/convert-for-loop-to-foreach.md)
###### [Get metodu ve özelliği arasında dönüştürme](ide/reference/convert-get-method-to-property.md)
###### [LINQ sorgusunu foreach deyimine dönüştürme](ide/reference/convert-linq-to-foreach.md)
...
###### [Açık tür kullanma](ide/reference/convert-var-to-explicit-type.md)
...
###### [Tanıma Göz At Özelliğini kullanarak kodu görüntüleme ve düzenleme](ide/how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
...
#### [Kaydırma çubuğunu özelleştirme](ide/how-to-track-your-code-by-customizing-the-scrollbar.md)
#### [Kodda yer işaretleri ayarlama](ide/setting-bookmarks-in-code.md)
#### [CodeLens ile kod geçmişi bulma](ide/find-code-changes-and-other-history-with-codelens.md)
...
#### [Sınıf diyagramı öğelerini Microsoft Office belgesine kopyalama](ide/class-designer/how-to-copy-class-diagram-elements-to-a-microsoft-office-document.md)
...
## [Performansı en iyi hale getirme](ide/optimize-visual-studio-performance.md)
...
### [Uygulamaları güvenli hale getirme](ide/securing-applications.md)
### [Güvenliği sürdürme](ide/maintaining-security.md)
### [Kullanıcı izinleri](ide/user-permissions-and-visual-studio.md)
...
## [Visual Studio Deneyimi İyileştirme Programı](ide/visual-studio-experience-improvement-program.md)
