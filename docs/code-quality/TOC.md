...
### [Yönetilen Kod İçin Kural Kümeleri Kullanma](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
#### [Birden Çok Proje İçin Kural Kümesi Belirtme](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [C++ Kodu İçin Kural Kümeleri Kullanma](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [Takım Projesi İade İlkesiyle Proje Kural Kümelerini Eşitleme](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
