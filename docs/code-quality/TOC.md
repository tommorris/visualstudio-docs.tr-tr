...
## [Özel Kural Kümesi Yapılandırma ve Kullanma](walkthrough-configuring-and-using-a-custom-rule-set.md)
# Nasıl yapılır kılavuzları
## Yönetilen Kod için Kod Analizi
### [Yönetilen Kod için Otomatik Kod Analizini Etkinleştirme ve Devre Dışı Bırakma](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Yönetilen Kod için Tam Çözüm Analizini Etkinleştirme ve Devre Dışı Bırakma](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Otomatik özelliği askıya alma](automatic-feature-suspension.md)
### [Yönetilen Kod İçin Kod Analizini El ile Çalıştırma](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [C/C++ Projeleri için Kod Analizi Özelliklerini Ayarlama](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
...
### [Yönetilen Kod Projesi İçin Kod Analizini Yapılandırma](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
### [Takım Projesi İade İlkesiyle Kod Proje Kural Kümelerini Eşitleme](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Bir Çözümde Birden Çok Proje İçin Yönetilen Kod Kural Kümesi Belirtme](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Özel Kod Analizi Kural Kümeleri Oluşturma](creating-custom-code-analysis-rule-sets.md)
#### [Özel Kural Kümesi Oluşturma](how-to-create-a-custom-rule-set.md)
#### [Kod Analizi Kural Kümesi Düzenleyicisini Kullanma](working-in-the-code-analysis-rule-set-editor.md)
...
### [Kod Analizi İade İlkeleri Oluşturma ve Kullanma](creating-and-using-code-analysis-check-in-policies.md)
#### [Standart Kod Analizi İade İlkeleri Oluşturma veya Güncelleştirme](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
#### [Bir Kod Analizi İade İlkesi ile Bakımı Yapılabilir Kodu Zorlama](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
