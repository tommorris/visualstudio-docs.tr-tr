# [Kod Çözümleme Araçları ile Uygulama Kalitesini Çözümleme](analyzing-application-quality-by-using-code-analysis-tools.md)
## [Kod Çözümlemesi ile Yönetilen Kod Kalitesini Çözümleme](analyzing-managed-code-quality-by-using-code-analysis.md)
### [Yönetilen Kod için Kod Çözümlemesine Genel Bakış](code-analysis-for-managed-code-overview.md)
### [Nasıl yapılır: Yönetilen Kod İçin Otomatik Kod Çözümlemesini Etkinleştirme ve Devre Dışı Bırakma](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Nasıl yapılır: Yönetilen Kod İçin Tam Çözüm Analizini Etkinleştirme ve Devre Dışı Bırakma](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Otomatik özelliği askıya alma](automatic-feature-suspension.md)
### [Nasıl yapılır: Yönetilen Kod İçin Kod Çözümlemesini Elle Çalıştırma](how-to-run-code-analysis-manually-for-managed-code.md)
### [İzlenecek yol: Kod Kusurları için Yönetilen Kodu Analiz Etme](walkthrough-analyzing-managed-code-for-code-defects.md)
### [SuppressMessage Özniteliğini Kullanarak Uyarıları Bastırma](suppress-warnings-by-using-the-suppressmessage-attribute.md)
#### [Kaynak Bastırmaya Genel Bakış](in-source-suppression-overview.md)
#### [Nasıl yapılır: Menü Öğesini Kullanarak Uyarıları Bastırma](how-to-suppress-warnings-by-using-the-menu-item.md)
### [Nasıl yapılır: Üretilen Kod İçin Kod Çözümleme Uyarılarını Bastırma](how-to-suppress-code-analysis-warnings-for-generated-code.md)
### [Nasıl yapılır: Kod Çözümleme Dizinini Özelleştirme](how-to-customize-the-code-analysis-dictionary.md)
### [Anonim Metotlar ve Kod Çözümleme](anonymous-methods-and-code-analysis.md)
### [Nasıl yapılır: Yönetilen Kod Kusurlarını Görüntüleme](how-to-view-managed-code-defects.md)
### [Nasıl yapılır: Yönetilen bir Kod Hatası için bir İş Öğesi Oluşturma](how-to-create-a-work-item-for-a-managed-code-defect.md)
...
##### [CA5351: Bozuk Şifreleme Algoritmaları Kullanmayın](ca5351-do-not-use-broken-cryptographic-algorithms.md)
...
##### [CA1024: Uygun yerlerde özellikler kullanın](ca1024-use-properties-where-appropriate.md)
...
##### [CA1050: Ad alanlarında türleri bildirin](ca1050-declare-types-in-namespaces.md)
...
##### [CA1307: StringComparison belirtin](ca1307-specify-stringcomparison.md)
...
##### [CA1501: Aşırı devralmadan kaçının](ca1501-avoid-excessive-inheritance.md)
...
##### [CA1717: Yalnızca FlagsAttribute numaralandırmalarında çoğul adlar olmalıdır](ca1717-only-flagsattribute-enums-should-have-plural-names.md)
...
##### [CA1824: Derlemeleri NeutralResourcesLanguageAttribute ile işaretleme](ca1824-mark-assemblies-with-neutralresourceslanguageattribute.md)
...
##### [CA2114: Yöntem güvenliği türün bir üst kümesi olmalıdır](ca2114-method-security-should-be-a-superset-of-type.md)
...
##### [CA2137: Saydam yöntemler yalnızca doğrulanabilir IL içermelidir](ca2137-transparent-methods-must-contain-only-verifiable-il.md)
...
##### [CA1801: Kullanılmayan parametreleri gözden geçir](ca1801-review-unused-parameters.md)
...
##### [CA2224: Eşittir işlecini aşırı yükleyerek eşittiri geçersiz kılın](ca2224-override-equals-on-overloading-operator-equals.md)
...
## [Kod Çözümlemesi ile C/C++ Kod Kalitesini Çözümleme](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
### [Hızlı Başlangıç: C/C++ İçin Kod Çözümleme](quick-start-code-analysis-for-c-cpp.md)
### [C/C++ İçin Kod Çözümlemesine Genel Bakış](code-analysis-for-c-cpp-overview.md)
...
### [Nasıl yapılır: C/C++ Projeleri için Kod Çözümleme Özelliklerini Ayarlama](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [İzlenecek yol: Kod Kusurları için C/C++ Kodunu Analiz Etme](walkthrough-analyzing-c-cpp-code-for-defects.md)
#### [Gösterim Örneği](demo-sample.md)
### [C/C++ Kod Hatalarını Azaltmak için SAL Ek Açıklamalarını Kullanma](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
#### [SAL'yi Anlama](understanding-sal.md)
...
### [Nasıl yapılır: __analysis_assume Kullanarak Ek Kod Bilgileri Belirtme](how-to-specify-additional-code-information-by-using-analysis-assume.md)
...
### [İzlenecek Yol: Özel bir Kural Kümesini Yapılandırma ve Kullanma](walkthrough-configuring-and-using-a-custom-rule-set.md)
### [Nasıl yapılır: Yönetilen Kod Projesi İçin Kod Çözümlemesini Yapılandırma](how-to-configure-code-analysis-for-a-managed-code-project.md)
### [Nasıl yapılır: Bir ASP.NET Web Uygulaması İçin Kod Çözümlemesini Yapılandırma](how-to-configure-code-analysis-for-an-aspnet-web-application.md)
### [Nasıl yapılır: Takım Projesi İade İlkesiyle Kod Proje Kural Kümelerini Eşitleme](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Nasıl Yapılır: Bir Çözümde Birden Çok Proje İçin Yönetilen Kod Kural Kümesi Belirtme](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Özel Kod Çözümlemesi Kural Kümeleri Oluşturma](creating-custom-code-analysis-rule-sets.md)
#### [Nasıl yapılır: Özel Kural Kümesi Oluşturma](how-to-create-a-custom-rule-set.md)
#### [Kod Çözümleme Kural Kümesi Düzenleyici'de Çalışma](working-in-the-code-analysis-rule-set-editor.md)
### [Kod çözümleme kural kümesi başvurusu](code-analysis-rule-set-reference.md)
...
## [Kod Çözümleme Uygulama Hataları](code-analysis-application-errors.md)
### [CA0001](ca0001.md)
### [CA0051](ca0051.md)
### [CA0052](ca0052.md)
### [CA0053](ca0053.md)
...
## [Takım Projesi İade İlkeleriyle Kod Kalitesini Arttırma](enhancing-code-quality-with-team-project-check-in-policies.md)
### [Kod Çözümleme İade İlkeleri Oluşturma ve Kullanma](creating-and-using-code-analysis-check-in-policies.md)
#### [Nasıl yapılır: Standart Kod Çözümleme İade İlkeleri Oluşturma veya Güncelleme](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
#### [Yönetilen Kod için Özel Kod Çözümleme İade İlkelerini Uygulama](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
#### [Nasıl yapılır: Bir Kod Çözümleme İade İlkesi ile Bakımı Yapılabilir Kodu Zorlama](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
#### [Kod Çözümleme İade İlkeleri için Sürüm Uyumluluğu](version-compatibility-for-code-analysis-check-in-policies.md)
# [Yönetilen Kodun Ölçüm Karmaşıklığı ve Bakımı](measuring-complexity-and-maintainability-of-managed-code.md)
## [Kod Ölçüm Değerleri](code-metrics-values.md)
## [Nasıl yapılır: Kod Ölçümleri Verileri Üretme](how-to-generate-code-metrics-data.md)
