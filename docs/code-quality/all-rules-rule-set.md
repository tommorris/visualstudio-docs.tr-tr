...
ms.locfileid: "31883884"
---
# <a name="all-rules-rule-set"></a>Tüm Kurallar kural kümesi

Tüm kurallar kural kümesi tüm yerel ve yönetilen kod için kurallar içerir. Kural kümesi aşağıdaki konularda açıklanan tüm kuralları içerir:
