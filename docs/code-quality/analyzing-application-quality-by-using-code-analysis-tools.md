...
### <a name="code-analysis-for-drivers"></a>Sürücüleri için Kod Analizi  
 Kod çözümleme araçları, sürücü kaynak kodu sistematik olarak çözümleyerek kararlılık ve güvenilirlik sürücünüzün artırmaya yardımcı olabilir.  
  
 [Kod çözümleme araçları kullanarak sürücü kalitesini analiz etme](http://go.microsoft.com/fwlink/?LinkId=227618)  
 Sürücüleri için Kod Analizi algılayan bir derleme zamanı statik doğrulama kodlama hataları C ve C++ programlarında temel araçtır ve hataları (birincil) çekirdek modu sürücüsü kodda algılamak için tasarlanan özel bir modülü içerir... Statik Sürücü Doğrulayıcı (SDV), Windows çekirdek modu sürücüleri kaynak kodunu sistematik olarak çözümleyen bir statik doğrulama aracıdır. Sürücünün doğru şekilde Windows işletim sisteminin çekirdek ile etkileşim SDV belirler.  
