...
ms.locfileid: "31889263"
---
# <a name="c26165"></a>C26165
C26165 Uyarı: büyük olasılıkla kilidi başarısız \<kilit > işlevindeki \<func >.

 Uyarı C26165 benzer uyarı [C26115](../code-quality/c26115.md) anlamlılık düzeyi daha düşük olması dışında. Örneğin, işlevi ek açıklama hataları içerebilir.

## <a name="example"></a>Örnek
 Aşağıdaki kod C26165 uyarı oluşturur.
...
## <a name="example"></a>Örnek
 Bu uyarı düzeltmek için önceki örnekte aşağıdaki değiştirin.
