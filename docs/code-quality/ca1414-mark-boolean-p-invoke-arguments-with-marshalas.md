...
## <a name="see-also"></a>Ayrıca Bkz.
 <xref:System.Runtime.InteropServices.UnmanagedType?displayProperty=fullName> [Yönetilmeyen kod ile birlikte çalışma](/dotnet/framework/interop/index)