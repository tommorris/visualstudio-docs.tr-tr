---
title: Visual Studio'da kod ölçümleri verileri üretme nasıl | Microsoft Docs
ms.custom: ''
ms.date: 12/12/2017
...
Kod ölçümleri sonuçları çözümün tamamında veya seçili proje oluşturabilirsiniz.

## <a name="to-generate-code-metrics-results-for-an-entire-solution"></a>Çözümün tamamında kod ölçümleri sonuçları oluşturmak için
...
1. İçinde **Çözüm Gezgini**, bir veya daha fazla projeleri seçin.

1. Menü çubuğundan seçin **Çözümle** > **hesapla kod ölçümleri** > **için < proje\>**.
