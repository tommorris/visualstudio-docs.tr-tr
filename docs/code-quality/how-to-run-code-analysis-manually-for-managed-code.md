---
title: "Nasıl yapılır: yönetilen kod için kod analizini elle çalıştırma | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
### <a name="to-run-code-analysis-manually"></a>Kod çözümleme el ile çalıştırmak için  
  
1.  İçinde **Çözüm Gezgini**, projeye tıklayın.  
  
2.  Üzerinde **Çözümle** menüsünde tıklatın **çalıştırmak kod çözümleme** *proje adı*.