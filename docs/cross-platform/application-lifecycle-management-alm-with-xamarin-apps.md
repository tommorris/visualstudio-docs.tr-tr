...
Başvuru bağlantısı:  **[hakkında Çevik araçları ve Çevik proje yönetimi](/azure/devops/boards/backlogs/overview?view=vsts)**
...
|Özellik|Xamarin ile desteklenen|Ek Açıklamalar|
|-------------|----------------------------|-------------------------|
|[Team Foundation sürüm denetimi (TFVC) kullanın](/azure/devops/repos/tfvc/overview?view=vsts) veya Azure depoları|Evet||
|[Azure depoları Git ile çalışmaya başlama](/azure/devops/repos/git/gitquickstart?view=vsts&tabs=visual-studio)|Evet||
...
|Özellik|Xamarin ile desteklenen|Ek Açıklamalar|
|-------------|----------------------------|-------------------------|
|Şirket içi TFS sunucusu|Evet|Derleme makinesi Xamarin yüklü olması ve iOS için oluşturmak için bir OSX bilgisayara bağlanabilir. Bkz: [TFVC kullanın](/azure/devops/repos/tfvc/overview?view=vsts)|
|Azure işlem hatlarına bağlı şirket içi yapı sunucusu|Evet|Bkz: [derleme ve yayın aracıları](/azure/devops/pipelines/agents/agents?view=vsts) yönergeler için.|
|Azure işlem hatlarını barındırılan denetleyici hizmeti|Evet|Bkz: [Xamarin uygulamanızı derleyin](/azure/devops/pipelines/languages/xamarin?view=vsts&tabs=vsts).|
...
|Kod kapsamı|yok||
|[Birim testi kod](../test/unit-test-your-code.md)|Evet|Windows ve Android hedefleri için yerleşik MSTest Araçlar kullanılabilir. Windows, Android ve iOS üzerinde birim testlerini çalıştırmak için Xamarin NUnit önerir. Bkz: [TFVC kullanan](/azure/devops/repos/tfvc/overview?view=vsts).|
...
|[Kod kopyası algılamayı kullanarak yinelenen kodu bulun](https://msdn.microsoft.com/library/hh205279.aspx)|Evet||
...
|[.NET Framework bellek sorunlarını çözümleme](https://msdn.microsoft.com/library/dn342825.aspx)|Hayır|Visual Studio Araçları, profil oluşturma için Mono framework uygulamasına kancaları yoktur.|
