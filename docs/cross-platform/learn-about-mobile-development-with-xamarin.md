...
1.  [Xamarin ile Visual Studio, Mobile Apps](https://visualstudio.microsoft.com/xamarin/) (visualstudio.com) Xamarin birincil özelliklerini kısa bir özetini sağlar.
