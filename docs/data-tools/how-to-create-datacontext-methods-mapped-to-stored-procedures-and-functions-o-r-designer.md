---
title: "Nasıl yapılır: saklı yordamları ve işlevleri (O R Tasarımcısı) eşlenen DataContext yöntemleri oluşturma | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Nasıl yapılır: LINQ sorguları yazma C# içinde](http://msdn.microsoft.com/Library/45e47fcc-cfa1-4b72-b161-d038ae87bd23)