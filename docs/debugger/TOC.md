...
## [Nasıl yapılır: Gizli hata ayıklayıcı komutlarını geri yükleme](how-to-restore-hidden-debugger-commands.md)
...
# [Visual Studio'da çok iş parçacıklı uygulamalarda hata ayıklama](debug-multithreaded-applications-in-visual-studio.md)
...
## [IntelliTrace ile olayları görüntüleme](walkthrough-using-intellitrace.md)
...
## [IntelliTrace tek başına toplayıcıyı kullanma](using-the-intellitrace-stand-alone-collector.md)
## [Microsoft İzleme Aracısı’nı kullanma](using-the-microsoft-monitoring-agent.md)
...
# [Uygulama hatalarını ayıklama](debugging-applications.md)
...
### [Visual Studio’dan UWP uygulamaları çalıştırma](run-store-apps-from-visual-studio.md)
#### [Yerel makinede UWP uygulamaları çalıştırma](run-windows-store-apps-on-the-local-machine.md)
...
### [Visual Studio’da UWP uygulamalarının hatalarını ayıklama](debug-store-apps-in-visual-studio.md)
#### [Visual Studio’da bir UWP uygulaması için hata ayıklama oturumu başlatma (VB, C#, C++ ve XAML)](start-a-debugging-session-for-a-store-app-in-visual-studio-vb-csharp-cpp-and-xaml.md)
...
#### [Visual Studio’da UWP Uygulamaları için hata ayıklama oturumu başlatma (JavaScript)](start-a-debugging-session-for-store-apps-in-visual-studio-javascript.md)
#### [Visual Studio hata ayıklama oturumunda bir UWP uygulamasının yürütülmesini denetleme (JavaScript)](control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md)
...
### [UWP uygulamalarında askıya alma, sürdürme ve arka plan olayları tetikleme]()
### [UWP uygulamalarında önceden getirilmiş içeriğin hatalarını ayıklama](prefetch-content-for-windows-store-apps.md)
