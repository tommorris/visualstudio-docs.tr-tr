---
title: "Hata ayıklayıcı Gezinti örnek kod (JavaScript) | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="debugger-navigation-sample-code-javascript"></a>Hata ayıklayıcı Gezinti örnek kod (JavaScript)
Örnek dosya için bu konudaki kodu [denetleyen bir hata ayıklama oturumunda (JavaScript) yürütme](../debugger/control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md) konu.  
