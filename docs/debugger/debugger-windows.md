...
|Görevler|CTRL: + SHIFT + D, K|[Görevleri penceresini kullanma](../debugger/using-the-tasks-window.md)| 
...
|Dinamik özellik Gezgini|-|[Hata ayıklama sırasında XAML özelliklerini denetleme](../debugger/inspect-xaml-properties-while-debugging.md)|   
