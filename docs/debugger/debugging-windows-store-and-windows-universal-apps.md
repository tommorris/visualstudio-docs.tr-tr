...
Hata ayıklama Evrensel Windows uygulamaları hakkında daha fazla bilgi için bkz: [dağıtma ve hata ayıklama UWP uygulamaları](/windows/uwp/debug-test-perf/deploying-and-debugging-uwp-apps).  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [Statik kod analizi kullanarak kod kalitesini çözümleme](../test/analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)