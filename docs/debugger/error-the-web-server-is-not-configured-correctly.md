...
4. Varsa `maxConnection` IIS'de sınırı çok düşük ve çok fazla bağlantıya sahip, gerekebilir [bağlantı sınırını artırmak](https://docs.microsoft.com/en-us/iis/configuration/system.applicationhost/sites/sitedefaults/limits).
