...
3.  Seçin **hata ayıklama özel durum** noktasında hata ayıklamayı başlatmak için nerede ve ne zaman özel durum oluştu.  
     ...
     ![IntelliTrace günlüğünü &#45; SharePoint işlenmeyen özel durumlar](../debugger/media/sharepointunhandledexceptions_intellitrace.png "SharePointUnhandledExceptions_IntelliTrace")  
...
|**Sütun**|**Gösterir**|  
|----------------|-------------------|  
|**ID**|İş parçacığı kimliği numarasını|  
