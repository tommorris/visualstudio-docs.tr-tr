...
Görselleştirici API'leri için Visual Studio hata ayıklayıcısı Görselleştirici yazma isteyen kullanıcılar için sağlanır. Görselleştirici kullanıcı arabirimi Visual Studio hata ayıklayıcısı işlevselliğini genişleten küçük bir uygulamadır. Görselleştirici görüntüleyebilir (ve isteğe bağlı olarak Düzenle) Görselleştirici tasarlanmış belirli bir türde bir veri nesnesi.  
