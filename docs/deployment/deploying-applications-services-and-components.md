...
| --- | --- |  
| **Buluta yayımlama:** , uygulamaları, hizmetleri ve veri bulunan Microsoft Azure'a dağıtmak için herhangi bir yere Visual Studio kullanarak yapabilirsiniz.|[Microsoft Azure için uygulama yayımlama](http://msdn.microsoft.com/library/windowsazure/ee460772.aspx) |
| **Bir Windows uygulaması yayımlama:** kolayca oluşturma, gönderme ve Microsoft Store, uygulamalardan dünya genelindeki müşteriler için satış. |[Windows uygulamaları yayımlama](https://developer.microsoft.com/store/publish-apps) |
...
| **Visual C++ uygulamasını dağıtma:** merkezi dağıtım, yerel dağıtım veya statik bağlama kullanarak bir uygulama ile Visual C++ çalışma zamanı dağıtabilirsiniz. | [Yerel Masaüstü uygulamaları dağıtma (Visual C++)](/cpp/ide/deploying-native-desktop-applications-visual-cpp.md) |
