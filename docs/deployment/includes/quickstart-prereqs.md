...
* [Visual Studio 2017](https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017) dilinizi tercih için uygun iş yükleri ile yüklenen:
...
* Bir ASP.NET Core, .NET Core, Python veya Node.js projesi. Bir proje zaten yoksa, aşağıdaki seçeneklerden birini seçin:
  ...
  * Python: İzleyin [hızlı başlangıç: Visual Studio kullanarak ilk Python web uygulamanızı oluşturma](../../ide/quickstart-python.md), veya **dosya** > **yeni proje**seçin **Python** seçeneğini belirleyip **Flask Web projesi**.
