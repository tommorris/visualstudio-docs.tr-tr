...
Visual Studio için Blend Visual Studio bir parçası olarak dahil olduğu için onu indirmeniz gerekmez. Ancak, sisteminizde yüklemek için Visual Studio Installer de seçmeniz gerekir.  
...
-   [Araçlar panelinde turu](#Tools)  
  
-   [Varlıklarını Masası turu](#Assets)  
  
-   [Zaman Çizelgesi ve nesneleri turu paneli](#Objects)  
  
-   [Özellikleri paneli turu](#Properties)  
  
##  <a name="Tools"></a>Araçlar panelinde turu  
...
##  <a name="Assets"></a>Varlıklarını Masası turu  
...
##  <a name="Objects"></a>Zaman Çizelgesi ve nesneleri turu paneli  
...
##  <a name="Properties"></a>Özellikleri paneli turu  
