---
title: m_taskId alan | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="mtaskid-field"></a>m_taskId alan
Yedekleme alanı için <xref:System.Threading.Tasks.Task.Id%2A?displayProperty=fullName> özelliği.  
