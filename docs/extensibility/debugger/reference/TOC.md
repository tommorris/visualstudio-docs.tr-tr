# [Başvuru (Visual Studio Hata Ayıklama API’leri)](reference-visual-studio-debugging-apis.md)
## [API Başvurusu (Visual Studio Hata Ayıklama)](api-reference-visual-studio-debugging.md)
### [Arabirimler (Visual Studio Hata Ayıklama)](interfaces-visual-studio-debugging.md)
#### [Temel Arabirimler](core-interfaces.md)
...
###### [IEnumDebugPropertyInfo2::Next](ienumdebugpropertyinfo2-reset.md)
...
#### [İfade Değerlendirme Arabirimleri](expression-evaluation-interfaces.md)
...
#### [Sembol Sağlayıcısı Arabirimleri](symbol-provider-interfaces.md)
...
### [Sabit Listeler (Visual Studio Hata Ayıklama)](enumerations-visual-studio-debugging.md)
...
### [Yapılar ve Birleşimler](structures-and-unions.md)
...
### [Hata Ayıklama için SDK Yardımcıları](sdk-helpers-for-debugging.md)
## [Visual Studio Hata Ayıklayıcısı Sözlüğü](visual-studio-debugger-glossary.md)
