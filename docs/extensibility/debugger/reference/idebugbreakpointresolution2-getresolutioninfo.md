...
ms.locfileid: "31103672"
---
# <a name="idebugbreakpointresolution2getresolutioninfo"></a>IDebugBreakpointResolution2::GetResolutionInfo
Bu kesme açıklar kesme noktası çözümleme bilgilerini alır.  
...
#### <a name="parameters"></a>Parametreler  
 `dwFields`  
 [in] Bayraklarını bileşimini [BPRESI_FIELDS](../../../extensibility/debugger/reference/bpresi-fields.md) hangi alanlarının belirlemek numaralandırma `pBPResolutionInfo` parametresi doldurulması üzeresiniz.  
  
 `pBPResolutionInfo`  
 [out] [BP_RESOLUTION_INFO](../../../extensibility/debugger/reference/bp-resolution-info.md) bu kesme noktası hakkında bilgi ile doldurulacak yapısı.  
