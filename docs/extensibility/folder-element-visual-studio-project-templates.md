...
|Öğe|Açıklama|  
|-------------|-----------------|  
|[Proje](../extensibility/project-element-visual-studio-templates.md)|İsteğe bağlı bir alt öğenin [TemplateContent](../extensibility/templatecontent-element-visual-studio-templates.md).|  
