...
-   Belirli bir pencere öğeleri yerleşik görüntüleme ve kategorileri kullanarak kullandığını IDE bildirmek `T:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyCategoryContainer` ve `T:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyContainer` arabirimleri.  
...
1.  Bir örneğini oluşturmak `T:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyCategoryContainer` arabirimi pencerenin uygulama ve başlatma bir parçası olarak.  
  
2.  Çağrı <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyCategoryContainer.GetPropertyCategory%2A> bir örneği elde etmek için yöntemi `T:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyContainer` geçerli karşılık gelen arabirimi <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView> örneği.  
