...
|[Özel düzenleyicileri ve tasarımcıları oluşturma](../extensibility/creating-custom-editors-and-designers.md)|Özel düzenleyicileri ve tasarımcıları nasıl oluşturulacağını açıklar.|  
