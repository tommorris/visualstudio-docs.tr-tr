...
## <a name="isolated-mode"></a>Yalıtılmış mod  
 ...
 Daha fazla bilgi için bkz: [Visual Studio yalıtılmış Kabuk](../extensibility/visual-studio-isolated-shell.md).  
  
## <a name="distributing-your-integrated-or-isolated-shell-application"></a>Tümleşik veya yalıtılmış Kabuk uygulamanızı dağıtma  
 Tümleşik veya yalıtılmış Kabuk uygulamanızı dağıtmak için uygulamanız, bir özel tümleşik veya yalıtılmış Kabuk yeniden dağıtılabilir ve bir yükleme programı eklemeniz gerekir. Dağıtım ve yükleme hakkında daha fazla bilgi için bkz: [dağıtma yalıtılmış kabuk uygulamaları](../extensibility/distributing-isolated-shell-applications.md).  
