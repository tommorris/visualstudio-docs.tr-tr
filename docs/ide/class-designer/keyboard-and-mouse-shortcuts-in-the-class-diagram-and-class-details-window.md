...
## <a name="using-the-mouse-in-class-designer"></a>Sınıf Tasarımcısı'nda fareyle  
...
## <a name="using-the-mouse-in-the-class-details-window"></a>Sınıf Ayrıntıları penceresinde fareyle  
...
## <a name="using-the-keyboard-in-class-designer"></a>Sınıf Tasarımcısı'nda için klavyeyi kullanma  
...
## <a name="using-the-keyboard-in-the-class-details-window"></a>Sınıf Ayrıntıları penceresinde klavye kullanma  
...
[Tür üyeleri yapılandırma ve oluşturma](creating-and-configuring-type-members.md)