...
Grupları [CodeSnippet](../ide/code-snippets-schema-reference.md#codesnippet) öğeleri. `CodeSnippets` Kod parçacığını XML şeması kök öğesinin bir öğedir.
