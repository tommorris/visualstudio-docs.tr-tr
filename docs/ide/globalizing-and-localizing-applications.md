...
## <a name="related-sections"></a>İlgili Bölümler
 ...
 Dil, ülke/bölge, takvimler kullanımda, tarihler, para birimi ve numaraları ve sıralama için biçim desenleri dizeleri için sipariş gibi kültürle ilgili bilgileri tanımlayan ve bu ad alanındaki sınıflar işaret eder.  
  
 <xref:System.Resources>  
 Sınıflar ve arabirimler geliştiricilerin oluşturmasını sağlar, bu ad alanındaki çıkış noktaları depolar ve bir uygulamada kullanılan çeşitli kültüre özgü kaynakları yönetir.