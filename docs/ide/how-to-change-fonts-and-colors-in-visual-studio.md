...
> [!TIP]
> Kod Düzenleyicisi renkleri değiştirme hakkında daha fazla bilgi için bkz: [nasıl yapılır: değiştirme yazı tiplerini ve renkleri Düzenleyicisi'nde](../ide/reference/how-to-change-fonts-and-colors-in-the-editor.md).
...
> [!TIP]
> Oluşturma ve Visual Studio Temalar yükleyerek Düzenle [Visual Studio renkli tema Düzenleyicisi](https://marketplace.visualstudio.com/items?itemName=VisualStudioProductTeam.VisualStudio2017ColorThemeEditor).
