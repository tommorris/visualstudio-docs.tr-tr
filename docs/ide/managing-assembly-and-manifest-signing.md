---
title: Derleme yönetmek ve bildirimlerini imzalama
ms.date: 02/17/2017
...
---
# <a name="manage-assembly-and-manifest-signing"></a>Derleme yönetmek ve bildirimlerini imzalama
...
Tanımlayıcı ad imzası bir yazılım bileşeni genel olarak benzersiz bir kimliği verir. Tanımlayıcı adlar derleme başka birisi tarafından gibi görünerek edilemez olduğunu garanti ve bileşen bağımlılıklar ve yapılandırma deyimleri doğru bileşeni ve bileşen sürümü harita sağlamak için kullanılır.
 ...
 Visual Basic ve C# projelerine imzalama derlemeler hakkında daha fazla bilgi için bkz: [tanımlayıcı adlı derlemeler oluşturma ve kullanma](http://msdn.microsoft.com/Library/ffbf6d9e-4a88-4a8a-9645-4ce0ee1ee5f9).
...
Bir anahtar dosyası belirtin. Yeni bir anahtar dosyası oluşturmayı seçerseniz, yeni anahtar dosyaları her zaman Not oluşturulan *.pfx* biçimi. Yeni dosya için bir ad ve parola gerekir.
