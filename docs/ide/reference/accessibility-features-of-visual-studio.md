...
description: Windows işletim sistemi ve Visual Studio Geliştirici paketi daha erişilebilir engelli kişiler de dahil olmak üzere herkes için yardımcı olun yardımcı programları ve erişilebilirlik özellikleri hakkında daha fazla bilgi edinin.
ms.date: 08/22/2017
...
-   [Nasıl yapılır: kümesi IDE erişilebilirlik seçenekleri](../../ide/reference/how-to-set-ide-accessibility-options.md)
