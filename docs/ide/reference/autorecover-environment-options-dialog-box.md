 ...
 **Otomatik Kurtarma bilgilerini kaydetme her \<n > dakika**  
 Bir dosya Düzenleyicisi'nde otomatik olarak ne sıklıkta kaydedilmiş özelleştirmek için bu seçeneği kullanın. Önceden kaydedilmiş dosyalar için dosyanın bir kopyasını kaydedilen \\... \My Documents\Visual Studio \< *sürüm*> \Backup dosyaları\\<*projectname*>. Dosyayı yeni ise ve el ile kaydedilmedi, dosya otomatik-rastgele oluşturulan dosya adını kullanarak kaydedilir.  
  
 **Otomatik Kurtarma bilgisini tutmak \<n > gün**  
