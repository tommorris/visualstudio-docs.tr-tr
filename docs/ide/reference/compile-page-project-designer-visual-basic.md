...
**Bireysel uyarılar katı seçeneği.**

**Uyarı yapılandırmaları** bölümünü **derleme sayfa** derleme zamanı hatasına neden olan üç koşulları karşılık gelen ayarlara sahip olduğunda `Option Strict` açıktır. Bu ayarlar aşağıda verilmiştir:
