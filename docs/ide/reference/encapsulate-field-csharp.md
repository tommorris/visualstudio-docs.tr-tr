---
title: "C# bir özellik için bir alan yeniden düzenlemeniz | Microsoft Docs"
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
1. Vurgula veya metin imleci kapsülleyen alanın adını içinde:
   ...
   ![Vurgulanmış kodu](media/encapsulate-highlight-cs.png)
...
1. Ardından, aşağıdakilerden birini yapın:
   ...
   **Alanı Yalıt (ancak hala alanını kullanın)** | Bir özellik alanıyla saklar, ancak alanının tüm kullanımları dokunulmadan bırakır
   ...
   ![Özellik sonuç yalıtma](media/encapsulate-result-cs.png)
