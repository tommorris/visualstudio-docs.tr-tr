...
Varsayılan olarak, bir Web projesini Visual Studio'da çalışan Visual Studio geliştirme sunucusu kullanır. Daha fazla bilgi için bkz: [ASP.NET Web projeleri için Visual Studio'da Web sunucuları](http://msdn.microsoft.com/en-us/31d4f588-df59-4b7e-b9ea-e1f2dd204328).  
