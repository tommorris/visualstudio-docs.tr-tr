...
-   **SAMI 1.0 anlama** Microsoft eşitlenmiş erişilebilir medya Değişimi (SAMI) teknolojisi PC multimedya için resim yazısı ses içeriğe geliştiriciler için bir yol sağlar. Daha fazla bilgi için bkz: [http://msdn.microsoft.com/en-us/library/ms971327.aspx](http://msdn.microsoft.com/library/ms971327.aspx).  
  
## <a name="windows-applications"></a>Windows uygulamaları  
  
-   [İzlenecek yol: erişilebilir Windows tabanlı bir uygulama oluşturma](http://msdn.microsoft.com/Library/654c7f2f-1586-480b-9f12-9d9b8f5cc32b) Bu konu örnek Windows uygulamasında Certified for Windows logosu için beş erişilebilirlik gereksinimleri dahil olmak üzere adım adım yönergeler sağlar.  
  
-   **Klavye kullanıcı arabirimi tasarımı için yönergeleri** bir Windows uygulama kullanıcı arabirimi, kullanıcıların tasarım klavyeden nasıl gidebilirsiniz teknik makalede açıklanır. Daha fazla bilgi için bkz: [http://msdn2.microsoft.com/library/ms971323.aspx](http://msdn2.microsoft.com/library/ms971323.aspx).  
...
-   **Web sayfaları daha erişilebilir hale getirme** teknik bu makalede, Web sitesi geliştirme kullanılmak üzere erişilebilir hale getirilebilir öğeleri yanı sıra erişilebilir HTML 3.2 öğeleri listeler. Daha fazla bilgi için bkz: [http://msdn2.microsoft.com/en-us/library/ms971309.aspx](http://msdn2.microsoft.com/library/ms971309.aspx).  
...
-   **Metin alternatifleri için erişilemez Web sayfaları** Bu teknik makale aynı Web sayfasının salt metin sürümleri gibi birden çok görünüm sağlamak için XML ve XSLT kullanmayı açıklar. Daha fazla bilgi için bkz: [http://msdn2.microsoft.com/library/aa468593.aspx](http://msdn2.microsoft.com/library/aa468593.aspx).  
