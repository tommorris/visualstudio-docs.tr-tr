---
title: "Eşitleme türü ve Visual Basic'te dosya adı | Microsoft Docs"
ms.custom: 
ms.date: 02/27/2017
ms.reviewer: 
ms.suite: 
...
1. Vurgula veya metin imleci eşitlemek için türünün adı içinde:
   ...
   ![Vurgulanmış kodu](media/synctype-highlight-vb.png)
...
1. Ardından, aşağıdakilerden birini yapın:
   ...
   * **Fare**
   ...
   ![Satır içi sonucu](media/synctype-result-vb.png)
