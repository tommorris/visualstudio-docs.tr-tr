...
> [!TIP]
> Veri Kaynağı Yapılandırma Sihirbazı'nı otomatik olarak çalıştırarak oluşturur ve çoğu veri öğeleri yapılandırır. Daha fazla bilgi için bkz: [yeni veri kaynakları ekleyin](../../data-tools/add-new-data-sources.md).
