---
title: Kısayol tuşları (Yardım Görüntüleyici)
ms.date: 11/02/2017
...
ms.locfileid: "31954265"
---
# <a name="shortcut-keys-help-viewer"></a>Kısayol tuşları (Yardım Görüntüleyici)

İçinde gidebilirsiniz **Microsoft Yardım Görüntüleyici** aşağıdaki tabloda kısayol tuşlarını kullanarak:

|Alan|Tuş vuruşu|Eylem|
|----------|---------------|------------|
|Genel Uygulama|**Alanı**|Yerine kullanmak **Enter** herhangi bir yere, düzenleme alanları dışındaki.|
...
|Araç Çubuğu|**Alt**+**giriş**|Görüntü **Yardım İnceleme** giriş sayfası.|
...
|Araç Çubuğu|**CTRL**+**F**|Görüntü **Bul** çubuğu konu alanında böylece geçerli konuda metinde arayabilirsiniz.|
...
|Gezginlerini|**Alt**+**t**<br /><br /> -VEYA-<br /><br /> **CTRL**+**Shift**+**t**|Görüntü **dizin** sekmesi.|
...
|Konu|**Kısayol menüsü** anahtarı<br /><br /> VEYA<br /><br /> **Shift**+**F10**|Geçerli kullanıcı Arabirimi öğesi için kısayol menüsünü görüntüler.|
