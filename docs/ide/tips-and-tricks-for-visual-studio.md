...
|Yüzen pencere yeniden yerleştirme|**CTRL**+ başlık çubuğunu çift tıklatın|
|Etkin belgeyi Kapat|**CTRL**+**F4**|
|Dosya Aç listesini göster|**CTRL**+**Alt**+**aşağı**|
...
|||
|-|-|
|Windows kayan taşıma/yerleştirme|**Win**+**sol** / **Win**+**sağ**|
|En üst düzeye/pencereleri simge durumuna küçültün|**Win**+**yukarı** / **Win**+**aşağı**|
...
|-|-|
|Hızlı Bul|**CTRL**+**F**|
|Sonraki sonuç Hızlı Bul|**Girin**|
|Hızlı Bul önceki sonucu|**Shift**+**girin**|
|Hızlı Bul, aşağı açılan genişletin|**Alt**+**aşağı**|
|Bul kapatın|**ESC**|
...
|Hızlı Eylemler|**Ctrl**+**.**||
|Parçacığı Seçici|**CTRL**+**K**,**X** veya **?**,**sekmesini** (VB)||
|İle surround|**CTRL**+**K**,**S**||
|Hızlı bilgi göster|**CTRL**+**K**,**t**||
|Gidin|**CTRL**+**,**||
|Vurgulanan başvuruları gidin|**CTRL**+**Shift**+**yukarı** (önceki), **Ctrl**+**Shift** + **Aşağı** (İleri)||
|Düzenleyici yakınlaştırma|**CTRL**+**Shift** + **>** (gelen) **Ctrl**+**Shift** + **<** (Giden)||
|Blok seçimi|Tutun **Alt** ve fare, sürükleyin **Shift**+**Alt**+**ok tuşları**||
...
|Normal belge sekmesine Peek tanımı penceresi Yükselt|**CTRL**+**Alt**+**giriş**||
