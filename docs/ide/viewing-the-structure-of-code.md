...
Nesneleri ve Visual Studio projelerinde üyeleri ve nesneleri ve .NET Framework bileşenlerini, COM bileşenleri, dinamik bağlantı kitaplığı (DLL) üyeleri inceleyin ve kitaplıkları (TLB) yazın.  
 ...
 Bu belge aşağıdaki bölümlerden farklı kod yapısı windows açıklanmaktadır.  
  
 [Sınıf Görünümü (Visual Basic, C# ' ta, C++)](#BKMK_ClassView)  
  
 [Çağrı hiyerarşisi (Visual Basic, C# ' ta, C++)](#BKMK_CallHierarchy)  
 ...
 Visual Studio Enterprise varsa, kodu ve bağımlılıklarını yapısını çözümün tamamında arasında görselleştirmek ve sizi ilgilendiren kod parçalarını kadar detaya için kod haritalarını kullanabilirsiniz. Daha fazla bilgi için bkz: [Çözümlerinizdeki bağımlılıkları eşleme](../modeling/map-dependencies-across-your-solutions.md).  
...
##  <a name="BKMK_CallHierarchy"></a>Çağrı hiyerarşisi (Visual Basic, C# ' ta, C++)  
