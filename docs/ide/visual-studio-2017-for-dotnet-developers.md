...
| **F12** (aynı zamanda **Ctrl**+**tıklatın**) | Tanıma gitme | Bir simge tanımlandığı gidin |
...
> [!NOTE]
> Bazı uzantılar varsayılan Visual Studio taşıyan bağlantı kesme. Aşağıdaki komutları kullanmak için taşıyan Visual Studio'nun ayarlarına giderek geri yüklemek **Araçları** > **içeri ve dışarı aktarma ayarları** > **Tümünü Sıfırla ayarları** veya **Araçları** > **seçenekleri** > **klavye** > **Sıfırla** .
...
Visual Studio 2017 adlı bir özelliği olan **tüm Git** (**Ctrl**+**T**). Tüm gidin, tüm dosya, türü, üye veya sembol bildirimi hızla atlamak sağlar.
...
Kullanabileceğiniz bir *.editorconfig* kodlama kurallarını kod oluşturma ve bunları kaynağınız ile seyahat sağlamak için dosya.
- Yüklemenizi öneririz [EditorConfig dil uzantısı Hizmetleri](https://aka.ms/editorconfig) eklemek ve düzenlemek için bir *.editorconfig* dosyasını Visual Studio'da.
- Kullanıma [belgelerine](https://aka.ms/editorconfigDocs) kodlama kuralı seçenekleri tüm .NET için.
- Bkz: [bu gist](https://gist.github.com/kuhlenh/5471666a7a2c57fea427e81cf0a41da8) bir örnek *.editorconfig*.
...
| Tanıma gitme | **F12** veya **Ctrl**+**' ı tıklatın**| Basılı tutabilirsiniz **Ctrl** navgiate tanımına tıklarken |
...
| Decompiled derlemeler gezinme | **F12** veya **Ctrl**+**' ı tıklatın** | Özelliği etkinleştirerek (ILSpy ile decompiled) dış kaynak gidin: **Araçları** > **seçenekleri** > **metin düzenleyici**  >  **C#** > **Gelişmiş** > **etkinleştirmek Gezinti decompiled kaynaklarına**. |
...
- [Dinamik birim testi](../test/live-unit-testing.md) sürekli, kod değişikliklerinden etkilenen testleri çalıştırır ve testlerinizi durumunu size bildirmek için satır içi Düzenleyicisi simgeler güncelleştirir. Eklemek veya belirli sınamalar hariç tutma veya test projelerden, *Canlı Test kümesi*.
...
- Sürekli tümleştirme ve projelerinizi Visual Studio ile içinde teslime ayarlama bizim [Visual Studio için kesintisiz teslim Araçları](https://marketplace.visualstudio.com/items?itemName=VSIDEDevOpsMSFT.ContinuousDeliveryToolsforVisualStudio) uzantısı ve Çevik Geliştirici iş akışı benimsemeyi.
...
|-|-|-|
| Çözüm Gezgini'nde dosyasını bulun | Çözüm Gezgini'nde etkin dosya vurgular | **Araçlar** > **seçenekleri** > **projeler ve çözümler** > **izlemek Çözüm Gezgini'nde etkin öğesi** |
| Kullanımları türleri başvuru derlemeleri ve NuGet paketleri ekleme | Ampul başvurulmayan türü için NuGet paketini yüklemek için bir kod düzeltmeyle gösterir | **Araçlar** > **seçenekleri** > **metin düzenleyici** > **C#** > **Gelişmiş**   >  **Başvuru derlemeleri türlerinde kullanımları önermek** ve **NuGet paketlerini türlerinde kullanımları önerisi** |
| Tam çözüm analizini etkinleştir | Çözümünüzdeki tüm hatalar görebilirsiniz **hata listesi** | **Araçlar** > **seçenekleri** > **metin düzenleyici** > **C#** > **Gelişmiş**   >  **Tam çözüm analizini etkinleştir** |
| Gezinti decompiled kaynaklarına etkinleştir | Tanıma Git türleri üyesi dış kaynaklardan ver ve yöntem gövdeleri göstermek için ILSpy decompiler kullanın | **Araçlar** > **seçenekleri** > **metin düzenleyici** > **C#** > **Gelişmiş**   >  **Decompiled kaynaklarına Gezinti etkinleştir** |
