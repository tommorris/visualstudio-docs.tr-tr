---
title: "Visual Studio Test denetleyicisi 2017 iş yükü ve Bileşen kimlikleri | Microsoft Docs"
description: "Visual Studio iş yükü ve Bileşen kimlikleri birden fazla makine için otomatikleştirilmiş testleri dağıtmak için kullanın"
keywords: 
author: TerryGLee
ms.author: tglee
manager: ghogen
...
**Kimliği:** Microsoft.VisualStudio.Workload.TestController

**Açıklama:** dağıtmak için birden fazla makine otomatikleştirilmiş test
...
--- | --- | --- | ---
Microsoft.VisualStudio.ComponentGroup.TestTools.TestController | Test denetleyicisi çekirdek özellikleri | 15.6.27309.0 | Gerekli
