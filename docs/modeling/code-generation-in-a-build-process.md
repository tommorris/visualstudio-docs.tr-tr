---
title: "Kod derleme sürecinde oluşturma | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
```  
 ...
 Bir yönerge işlemcisi içinde çağırabilirsiniz <xref:Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost.ResolveParameterValue%2A>:  
