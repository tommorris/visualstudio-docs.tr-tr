...
ms.locfileid: "39567174"
---
# <a name="customizing-the-properties-window"></a>Özellikler Penceresini Özelleştirme
İçinde etki alanına özgü dil (DSL) görünümünü ve davranışını özellikler penceresinin özelleştirebilirsiniz [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. DSL tanımındaki her etki alanı sınıfı üzerinde etki alanı özelliklerini tanımlayın. Diyagram üzerinde veya Model Gezgini'nde sınıfının bir örneğini seçtiğinizde varsayılan olarak, her etki alanı özelliği Özellikler penceresinde listelenir. Bunları diyagramdaki şekil alanları eşlenmedi olsa bile bu görmek ve etki alanı özelliklerinin değerlerini düzenlemek, sağlar.
