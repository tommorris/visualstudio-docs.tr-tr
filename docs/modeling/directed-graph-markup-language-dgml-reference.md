...
-   `<Category/>`  
     ...
     Kategoriler de haritada görüntülendiğinde, düğümleri ve bağlantıları görünümünü denetleyen bazı temel şablon davranışı sağlar. Bkz: [Özelleştir kod eşlemeleri DGML dosyalarını düzenleyerek](../modeling/customize-code-maps-by-editing-the-dgml-files.md).  
