...
## <a name="accessing-the-current-selection-from-a-command-handler"></a>Geçerli seçim komut işleyicisinden erişme  
...
## <a name="determining-which-window-is-active"></a>Hangi pencere etkin olduğunu belirleme  
