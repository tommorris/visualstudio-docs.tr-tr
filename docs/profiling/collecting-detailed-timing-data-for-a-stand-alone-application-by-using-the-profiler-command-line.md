...
|Görev|İlgili içerik|  
|----------|---------------------|  
|**Örnekleme kullanarak profil oluşturma uygulamaları**|-   [Örnekleme kullanarak uygulama istatistikleri toplama](../profiling/collecting-application-statistics-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
|**Profil Oluşturucu .NET bellek ayırma ve çöp toplama**|-   [.NET Framework bellek verileri toplama](../profiling/collecting-dotnet-framework-memory-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
...
|Görev|İlgili içerik|  
|----------|---------------------|  
|**ASP.NET uygulamalarının profilini oluşturma**|-   [İzleme kullanarak ayrıntılı zamanlama verileri toplama](../profiling/collecting-detailed-timing-data-for-an-aspnet-web-application-using-the-profiler-instrumentation-method.md)|  
