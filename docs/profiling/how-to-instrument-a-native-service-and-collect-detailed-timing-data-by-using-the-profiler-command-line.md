...
Bu makalede nasıl kullanılacağını açıklar [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] yerel (C/C++) işaretlemesini profil oluşturma araçları komut satırı araçları hizmet ve ayrıntılı zamanlama verileri toplama.  
