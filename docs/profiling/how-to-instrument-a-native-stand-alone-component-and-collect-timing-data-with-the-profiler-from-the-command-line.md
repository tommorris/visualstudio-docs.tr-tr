...
ms.locfileid: "34815892"
---
# <a name="how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line"></a>Nasıl yapılır: yerel bir bağımsız bileşeni izleme ve komut satırından Profil Oluşturucu ile zamanlama verileri toplama
Bu konuda nasıl kullanılacağını açıklar [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] profil oluşturma araçları komut satırı araçları C++ gibi yerel bir bileşeni işaretlemesini. *exe* veya. *dll* dosyasını ve ayrıntılı zamanlama verileri toplamak için.  
...
3.  Profil Oluşturucu başlatın. Tür:  
    ...
    |[/crosssession](../profiling/crosssession.md)|Etkinleştirir, diğer oturumlarda işlemleri profil oluşturma. Bu seçenek, uygulamanın farklı bir oturumda çalışıyorsa gereklidir. Oturum tanımlayıcısı listelenen **oturum kimliği** İşlemler sekmesinde Windows Görev Yöneticisi'nin sütun. **/CS** için bir kısaltma olarak belirtilen **/crosssession**.|  
