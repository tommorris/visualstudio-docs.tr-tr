...
## <a name="in-this-section"></a>Bu bölümde  
 ...
 Profil oluşturma verileri modülü ve profil oluşturma verilerini modülünde işlevler için listeleri göre düzenler.  
  
 [Arayan/Aranan görünümü - izleme verileri](../profiling/caller-callee-view-instrumentation-data.md)  
 Profil oluşturma verilerini seçili işlevinin üst ve alt işlevler için görüntüler.  
  
 [İşlevler Görünümü](../profiling/functions-view-instrumentation-data.md)  
 İşlev tarafından profil oluşturma verilerini listeler.  
