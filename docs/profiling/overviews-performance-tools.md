...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 Örnekleme profili oluşturma yöntemi kullandığınızda, raporlanan veri değerleri öğrenin.  
 ...
 Bir performans oturumda ek performans verileri sağlayan CPU ve Windows performans sayaçları hakkında bilgi edinin.  
