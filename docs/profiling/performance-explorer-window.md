...
**Performans Gezgini** penceresinde [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] tümleşik geliştirme ortamı (IDE) etkinleştirir, yapılandırmak ve kullanarak performans oturumlarını başlatmak [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] profil oluşturma araçları.  
...
-   **Başlatma** - **başlatma** komut düğmesi listesi hemen etkin profil olan hedef uygulamayı başlatmak etkinleştirir (**başlatma profil oluşturucu**) veya askıya alınmış (profil oluşturma **Profil oluşturma ile Başlat duraklatılır**).  
