...
-   Aynı bilgisayarda Microsoft HPC Pack 2008 yükleme [!INCLUDE[vsPreLong](../code-quality/includes/vsprelong_md.md)]. Bilgisayar HPC kümesinin parçası olmak zorunda değildir. HPC paketini yükleyebilirsiniz [Microsoft Download Center](http://go.microsoft.com/fwlink/?LinkID=177414).  
  
-   Yükleme [!INCLUDE[net_v40_long](../code-quality/includes/net_v40_long_md.md)] ve HPC profil oluşturma araçları tek başına bir sürümünü işlem düğümü. Program için yükleme [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] ve tek başına profil oluşturucu bulunur [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] yükleme medyası. **Not** yükledikten sonra işlem yeniden başlatmanız gerekir [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] ve profil oluşturma araçları yüklemeden önce.  
...
|*% FxPath %*|Yolu [!INCLUDE[net_v40_long](../code-quality/includes/net_v40_long_md.md)] yükleyici. Üzerinde [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] yolu yükleme medyasını: WCU\dotNetFramework\dotNetFx40_Full_x86_x64.exe|  
|*% ProfilerPath %*|Profil oluşturma araçları yükleyici tek başına sürümü yolu. Üzerinde [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] yolu yükleme medyasını: tek başına Profiler\x64\vs_profiler.exe|  
...
#### <a name="to-profile-on-an-hpc-compute-node"></a>Bir HPC işlem düğümünde profilini  
