...
|**Yönetici:** \< *hizmet*&#124; *Sürücü*>\<**Başlat**&#124; **Durdur**&#124; **Yükleme**&#124; **KALDIRMA**>|Başlatır, durdurur, yükler veya profil oluşturma hizmeti bileşeni (hizmeti) veya çekirdek modu aygıt sürücüsü (sürücü) kaldırır.|  
|**Yönetici:** \< *hizmet*&#124; *Sürücü*>**AutoStart**\<**ON**&#124; **KAPALI**>|Etkinleştirir veya bir yeniden başlatma sonrasında profil oluşturma hizmeti (hizmeti) veya çekirdek modu aygıt sürücüsü (sürücü) otomatik olarak başlatılmasını devre dışı bırakır.|  
