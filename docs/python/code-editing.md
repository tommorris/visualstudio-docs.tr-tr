...
- [IntelliSense](#intellisense) tamamlamalar, imza Yardım, hızlı bilgi ve kod renklendirme dahil olmak üzere.
- [Kod parçacıkları](#code-snippets)
- [Kodunuzu gezinme](#navigating-your-code)
...
> [!Tip]
> Kodu renklendirme devre dışı bırakmak için şu adrese gidin **Araçlar > Seçenekler > Metin Düzenleyicisi > Python > Gelişmiş** ve temizleyin **çeşitli seçenekleri > Renk türüne göre adları**. Bkz: [seçenekleri - çeşitli seçenekleri](options.md#miscellaneous-options).
