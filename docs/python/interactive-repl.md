---
title: "Visual Studio'da Python etkileşimli REPL | Microsoft Docs"
ms.custom: 
ms.date: 07/13/2017
ms.reviewer: 
ms.suite: 
...
Etkileşimli penceresinden çeşitli yönlerini kontrol edebilir **Araçlar > Seçenekler > Python araçları > Etkileşimli Windows** (bkz [seçenekleri](options.md)):
...
Bu davranış bir sorun varsa, ayarları değiştirin **Araçlar > Seçenekler > Python araçları > Etkileşimli Windows** içinde **tamamlanma modu** açıklandığı gibi Grup [seçenekleri - Etkileşimli Windows seçenekleri](options.md#interactive-windows-options).
