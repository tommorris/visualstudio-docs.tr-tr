...
Windows üzerinde Visual Studio'da [ **Python ortamları** ](#the-python-environments-window) penceresinde, bu makalede açıklandığı gibi burada bu ortamlarını yönetin ve yeni projeler için varsayılan olarak seçin. Verilen herhangi bir proje için ayrıca [belirli bir ortam seçin](selecting-a-python-environment-for-a-project.md) yerine varsayılan kullanın.

>[!NOTE]
>Visual Studio'da Python yeniyseniz, gerekli arka plan için aşağıdaki makalelere bakın:
>
...
Her iki durumda da **Python ortamları** penceresi görünür bir eşdüzey sekmeye olarak **Çözüm Gezgini**:
...
Bir ortam seçerek herhangi bir yolla etkinleştirmez. Kalın listesinde gösterilen varsayılan ortamı, tüm yeni projeler için Visual Studio kullanan etkin ortamıdır. Farklı bir ortama etkinleştirmek için kullandığınız **varsayılan ortama yeni projeler için bunu yap** komutu. Bir proje bağlamında farklı bir ortam her zaman etkinleştirebilirsiniz. Daha fazla bilgi için [bir proje için bir ortam seçin](selecting-a-python-environment-for-a-project.md).
