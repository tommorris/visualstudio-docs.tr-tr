...
2.  İçinde **yeni proje** iletişim kutusunda, ya da altında **Visual C#** veya **Visual Basic**, genişletin **Office/SharePoint** düğümünü ve ardından seçin **SharePoint çözümlerini** kategorisi.  
  
3.  Proje şablonları listesinden seçip **SharePoint 2013 - Visual Web Bölümü**ve ardından **Tamam** düğmesi.  
  
     **SharePoint Özelleştirme Sihirbazı'nı** görüntülenir.  
  
4.  Üzerinde **hata ayıklama için site ve güvenlik düzeyini belirtmek** sayfasında, yerel bilgisayardaki bir SharePoint sitesinin URL'sini belirtin ve ardından **son** düğmesi.  
  
     İçinde **Çözüm Gezgini**, bir web bölümü görünür. Visual Web Developer Tasarımcısı'nda web bölümü tasarladıktan sonra belirttiğiniz sitesinde sınayacaksınız.  
...
3.  Proje şablonları listesinden seçip **Visual Web Bölümü**adlandırın ve ardından **Ekle** düğmesi.  
