...
-   [!INCLUDE[vsPro](../sharepoint/includes/vspro-md.md)]veya bir sürümü, Visual Studio uygulama yaşam döngüsü yönetimi (ALM).  
  
    -   Ya da [!INCLUDE[csprcs](../sharepoint/includes/csprcs-md.md)] veya [!INCLUDE[vbprvb](../sharepoint/includes/vbprvb-md.md)] özelliği veya her ikisini de yüklerken [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)].  
