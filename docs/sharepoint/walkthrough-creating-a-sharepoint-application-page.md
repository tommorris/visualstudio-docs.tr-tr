...
-   [!INCLUDE[vsPro](../sharepoint/includes/vspro-md.md)]veya Visual Studio Ultimate veya Visual Studio Premium sürümü.  
...
#### <a name="to-design-the-layout-of-the-application-page"></a>Uygulama sayfasının düzenini tasarlamak için  
...
#### <a name="to-handle-the-events-of-controls-on-the-page"></a>Sayfadaki denetimlerin olaylarını işlemek için  
