...
#### <a name="to-create-a-feature-receiver"></a>Özellik alıcısı oluşturmak için  
...
#### <a name="to-add-code-to-the-feature-receiver"></a>Özellik alıcısına kod eklemek için  
...
#### <a name="to-debug-and-fix-the-sharepoint-solution"></a>Hata ayıklamak ve SharePoint çözümünü düzeltmek için  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [Doğrulama ve SharePoint kodda hata ayıklama](../sharepoint/verifying-and-debugging-sharepoint-code.md)   
 [IntelliTrace](/visualstudio/debugger/intellitrace)   
 [İzlenecek yol: Birim testleri kullanarak SharePoint kodunu doğrulayın.](https://msdn.microsoft.com/en-us/library/gg599006(v=vs.100).aspx)  
