...
|-----------|-----------------------|
|**Yük testi için test karışımını belirtme:** bir yük testi oluşturduğunuzda, yük testi için ayarları belirtin **Yeni Yük Testi Sihirbazı**. İçinde **Yeni Yük Testi Sihirbazı**, ilk senaryoya eklemek için var olan Web ve birim testi seçin. Testleri senaryoya ekledikten sonra test karışımını senaryosu için belirtin.<br /><br /> Bir Web sitesi veya yük test ettiğiniz uygulamanın beklenen gerçek dünya kullanımını daha doğru bir şekilde tahmin etmek için yük modelleme seçenekleri kullanın. Bir doğru yük modeli dayalı olmayan bir yük testi yanıltıcı sonuçlara neden olabilir çünkü bunu yapmak önemlidir.|-   [Bir web sitesi veya uygulamanın beklenen gerçek hayatta kullanımı öykünün](../test/emulate-real-world-usage-of-a-web-site-in-a-load-test-using-test-mix-models.md)|
...
7.  (İsteğe bağlı) Başlatma veya onay kutularını kullanarak ve istenen testleri seçerek sonlandırmak için bir Web başarım ve birim testi belirtin. Daha fazla bilgi için [Emulate gerçek hayatta kullanımı bir web sitesi veya uygulamanın beklenen](../test/emulate-real-world-usage-of-a-web-site-in-a-load-test-using-test-mix-models.md).
