...
|Kenar|Kayıtlı eylem adımları veya nesne özelliklerini görüntülemek için oluşturucu kullanma desteklenmiyor. Testleri yürütülen geri Edge tarayıcısı kullanarak Visual Studio 2015 güncelleştirme 2 ve üzeri sürümleri kullanarak üzerinde [Coded UI Cross Browser Testing uzantısı](https://visualstudiogallery.msdn.microsoft.com/11cfc881-f8c9-4f96-b303-a2780156628d)|
...
|Dynamics (Ax) 2012 işlemcisi|Eylem kaydı ve kayıttan yürütme kısmen desteklenir. Bkz: [Visual Studio 10 kodlanmış UI / eylem kaydı desteklemek için Microsoft Dynamics](https://blogs.msdn.microsoft.com/dave_froslie/2011/09/01/visual-studio-10-coded-ui-action-recordings-support-for-microsoft-dynamics-ax-2012/) Ayrıntılar için.|
|SAP|Desteklenmez.|
