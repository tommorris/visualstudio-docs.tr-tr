...
##  <a name="BKMK_In_this_topic"></a>Bu konudaki  
 ...
 [Varolan bir teste dönüştürme](#BKMK_Converting_an_existing_test)  
  
-   [Bir test projesi için Öykünücüler paketi ekleme](#BKMK_Adding_the_Emulators_package_to_a_test_project)  
  
-   [Test yöntemi öykünme ile çalıştırma](#BKMK__Running_a_test_method_in_the_emulation_context)  
  
 [Çift kullanımlı sınıflar ve yöntemler oluşturma](#BKMK_Creating_dual_use_classes_and_methods)  
  
 [Çift kullanımı oluşturmak için öznitelikleri sınıfı test TestInitialize ve TestCleanup kullanma](#BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class)  
  
 [İşleme benzetilmiş SharePoint yöntemleri](#BKMK_Handling_non_emulated_SharePoint_methods)  
  
 [Karalama ve bir Özet yazma öykünme testleri](#BKMK_Writing_emulation_tests_from_scratch__and_a_summary)  
...
-   Microsoft SharePoint 2010 (SharePoint Server 2010 veya SharePoint 2010 Foundation)  
...
##  <a name="BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class"></a>Çift kullanımı oluşturmak için öznitelikleri sınıfı test TestInitialize ve TestCleanup kullanma  
