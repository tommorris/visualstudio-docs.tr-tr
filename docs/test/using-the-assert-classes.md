---
title: Birim Visual Studio'da Test etmek için onay sınıfları kullanma
ms.date: 11/04/2016
...
> [!NOTE]
> Ignore özniteliği ile çalıştırmak hazır değil bir test işaretlemek için alternatif bir strateji etmektir. Ancak, bu kolayca uygulamak üzere bıraktıysanız sınamaların sayısı raporda üretilemiyor olumsuz sahiptir.
