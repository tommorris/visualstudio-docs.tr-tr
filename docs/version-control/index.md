...
- [Git geçişinizi planlama](https://docs.microsoft.com/azure/devops/git/centralized-to-git)
- [TFVC'yi geçirmek için Git](https://docs.microsoft.com/azure/devops/git/migrate-from-tfvc-to-git)