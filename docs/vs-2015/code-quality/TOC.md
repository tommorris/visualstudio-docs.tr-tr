# [Uygulama Kalitesini Analiz Etme](analyzing-application-quality-by-using-code-analysis-tools.md)
## [Yönetilen Kod Kalitesini Analiz Etme](analyzing-managed-code-quality-by-using-code-analysis.md)
### [Yönetilen Kod için Kod Çözümlemesine Genel Bakış](code-analysis-for-managed-code-overview.md)
### [Nasıl Yapılır: Otomatik Kod Çözümlemesini Etkinleştirme ve Devre Dışı Bırakma](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Nasıl Yapılır: Tam Çözüm Analizini Etkinleştirme ve Devre Dışı Bırakma](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Otomatik özelliği askıya alma](automatic-feature-suspension.md)
### [Nasıl Yapılır: Kod Çözümlemesini El ile Çalıştırma](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [Nasıl Yapılır: Üretilen Kod İçin Uyarıları Bastırma](how-to-suppress-code-analysis-warnings-for-generated-code.md)
...
#### [CheckId Uyarıları](code-analysis-warnings-for-managed-code-by-checkid.md)
...
## [C/C++ Kod Kalitesini Analiz Etme](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
...
#### [En İyi Yöntemler ve Örnekler](best-practices-and-examples-sal.md)
...
### [Nasıl Yapılır: Bir Çözümde Birden Çok Proje İçin Kural Kümesi Belirtme](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Özel Kural Kümeleri Oluşturma](creating-custom-code-analysis-rule-sets.md)
#### [Nasıl yapılır: Özel Kural Kümesi Oluşturma](how-to-create-a-custom-rule-set.md)
#### [Kural Kümesi Düzenleyici'de Çalışma](working-in-the-code-analysis-rule-set-editor.md)
...
#### [Yönetilen Kod için Özel İade İlkelerini Uygulama](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
