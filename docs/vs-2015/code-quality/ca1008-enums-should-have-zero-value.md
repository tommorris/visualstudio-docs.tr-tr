...
| Yeni değişiklik | Eklemek için istendiğinde bölünemez - bir **hiçbiri** bayrağı olmayan bir sabit listesi değeri. Yeniden adlandırmakta ya da tüm sabit listesi değerleri kaldırmak isteyip istemediğiniz sorulduğunda bozucu -. |  
