...
ms.locfileid: "42689765"
---
# <a name="mixed-minimum-rules-rule-set"></a>Karışık Minimum Kurallar kural kümesi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [karışık Minimum kurallar kural kümesi](https://docs.microsoft.com/visualstudio/code-quality/mixed-minimum-rules-rule-set).  
