...
ms.locfileid: "42678860"
---
# <a name="native-minimum-rules-rule-set"></a>Yerel Minimum Kurallar kural kümesi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [yerel Minimum kurallar kural kümesi](https://docs.microsoft.com/visualstudio/code-quality/native-minimum-rules-rule-set).  
