...
ms.locfileid: "42634373"
---
# <a name="usage-warnings"></a>Kullanım Uyarıları
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [kullanım uyarıları](https://docs.microsoft.com/visualstudio/code-quality/usage-warnings).  
