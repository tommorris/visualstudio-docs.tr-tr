# [Arabirim Erişimi SDK'sında Hata Ayıklama](debug-interface-access-sdk.md)
## [Başlarken](getting-started-debug-interface-access-sdk.md)
### [Genel bakış](overview-debug-interface-access-sdk.md)
### [.Pdb Dosyasını Sorgulama](querying-the-dot-pdb-file.md)
## [Simgeler ve Simge Etiketleri](symbols-and-symbol-tags.md)
### [Simge Konumları](symbol-locations.md)
### [Simge Türlerinin Sözcük Hiyerarşisi](lexical-hierarchy-of-symbol-types.md)
#### [Ek Açıklama](annotation.md)
#### [Block](block.md)
#### [Compiland](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Özel (Arabirim Erişimi SDK'sında Hata Ayıklama)](custom-debug-interface-access-sdk.md)
#### [Veriler (Arabirim Erişimi SDK'sında Hata Ayıklama)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [İşlev (Arabirim Erişimi SDK'sında Hata Ayıklama)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [Etiket (Arabirim Erişimi SDK'sında Hata Ayıklama)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Dönüştürücü](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [Simge Türlerinin Sınıf Hiyerarşisi](class-hierarchy-of-symbol-types.md)
#### [ArrayType](arraytype.md)
#### [BaseClass](baseclass.md)
#### [BaseType](basetype.md)
#### [CustomType](customtype.md)
#### [Boyut](dimension.md)
#### [Enum (Arabirim Erişimi SDK'sında Hata Ayıklama)](enum-debug-interface-access-sdk.md)
#### [Arkadaş (Arabirim Erişimi SDK'sında Hata Ayıklama)](friend-debug-interface-access-sdk.md)
#### [FunctionArgType](functionargtype.md)
#### [FunctionType](functiontype.md)
#### [ManagedType](managedtype.md)
#### [PointerType](pointertype.md)
#### [Tür Tanımı (Arabirim Erişimi SDK'sında Hata Ayıklama)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [Başvuru](debug-interface-access-sdk-reference.md)
### [Arabirimler (Arabirim Erişimi SDK'sında Hata Ayıklama)](interfaces-debug-interface-access-sdk.md)
...
##### [IDiaInjectedSource::get_filename](idiainjectedsource-get-objectfilename.md)
...
#### [BasicType Numaralandırması](basictype.md)
#### [CV_access_e Numaralandırması](cv-access-e.md)
#### [CV_call_e Numaralandırması](cv-call-e.md)
#### [CV_CFL_LANG Numaralandırması](cv-cfl-lang.md)
#### [CV_CPU_TYPE_e Numaralandırması](cv-cpu-type-e.md)
#### [CV_HREG_e Numaralandırması](cv-hreg-e.md)
#### [DataKind Numaralandırması](datakind.md)
#### [DiaAddressMapEntry Yapısı](diaaddressmapentry.md)
#### [LocationType Numaralandırması](locationtype.md)
#### [MemoryTypeEnum Numaralandırması](memorytypeenum.md)
#### [NameSearchOptions Numaralandırması](namesearchoptions.md)
#### [StackFrameTypeEnum Numaralandırması](stackframetypeenum.md)
#### [SymTagEnum Numaralandırması](symtagenum.md)
#### [THUNK_ORDINAL Numaralandırması](thunk-ordinal.md)
#### [UdtKind Numaralandırması](udtkind.md)
### [Sabitler (Arabirim Erişimi SDK'sında Hata Ayıklama)](constants-debug-interface-access-sdk.md)
## [Dia2dump Örneği](dia2dump-sample.md)
## [Dia2dump.cpp Kaynak Dosyası](dia2dump-cpp-source-file.md)
