...
Bu konuda en son sürümünü şu yolda bulunabilir: [Idialinenumber::get_relativevirtualaddress](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idialinenumber-get-relativevirtualaddress).  
