...
ms.locfileid: "42687423"
---
# <a name="idiasymbolgetcode"></a>IDiaSymbol::get_code
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [Idiasymbol::get_code](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-code).  
