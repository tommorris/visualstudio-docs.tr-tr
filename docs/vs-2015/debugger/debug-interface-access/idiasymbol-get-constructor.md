...
Bu konuda en son sürümünü şu yolda bulunabilir: [Idiasymbol::get_constructor](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-constructor).  
