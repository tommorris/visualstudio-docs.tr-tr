...
Bu konuda en son sürümünü şu yolda bulunabilir: [Idiasymbol::get_volatiletype](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-volatiletype).  
