...
ms.locfileid: "42634038"
---
# <a name="debugger-navigation-sample-code-xaml-and-c"></a>Hata ayıklayıcı gezintisi örnek kodu (Xaml ve C#)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [hata ayıklayıcı gezintisi örnek kodu (Xaml ve C#)](https://docs.microsoft.com/visualstudio/debugger/debugger-navigation-sample-code-xaml-and-csharp).  
