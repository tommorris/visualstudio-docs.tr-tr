...
ms.locfileid: "42629388"
---
# <a name="graphics-event-list"></a>Grafik Olay Listesi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [grafik olay listesi](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-event-list).  
