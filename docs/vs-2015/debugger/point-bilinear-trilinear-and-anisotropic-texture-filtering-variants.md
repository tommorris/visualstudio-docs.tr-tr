...
Bu konuda en son sürümünü şu yolda bulunabilir: [noktası, ikili Trilinear ve Anizotropik doku filtreleme çeşitleri](https://docs.microsoft.com/visualstudio/debugger/graphics/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants).  
