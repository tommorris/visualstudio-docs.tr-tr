...
ms.locfileid: "42687939"
---
# <a name="clickonce-application-manifest"></a>ClickOnce Uygulama Bildirimi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [ClickOnce Uygulama bildirimi](https://docs.microsoft.com/visualstudio/deployment/clickonce-application-manifest).  
