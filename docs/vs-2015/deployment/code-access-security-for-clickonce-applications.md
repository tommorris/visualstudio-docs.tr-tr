...
ms.locfileid: "42632119"
---
# <a name="code-access-security-for-clickonce-applications"></a>ClickOnce Uygulamaları İçin Kod Erişimi Güvenliği
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [ClickOnce uygulamaları için kod erişimi güvenliği](https://docs.microsoft.com/visualstudio/deployment/code-access-security-for-clickonce-applications).  
