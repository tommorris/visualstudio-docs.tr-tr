...
Bu konuda en son sürümünü şu yolda bulunabilir: [ &lt;bağımlılık&gt; öğesi (ClickOnce uygulaması)](https://docs.microsoft.com/visualstudio/deployment/dependency-element-clickonce-application).  
