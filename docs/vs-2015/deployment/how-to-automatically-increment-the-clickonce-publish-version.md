...
Bu konuda en son sürümünü şu yolda bulunabilir: [nasıl yapılır: ClickOnce yayımlama sürüm otomatik artış](https://docs.microsoft.com/visualstudio/deployment/how-to-automatically-increment-the-clickonce-publish-version).  
