...
Bu konuda en son sürümünü şu yolda bulunabilir: [izlenecek yol: bir gizlilik istemi göstermek için özel bir önyükleyici oluşturma](https://docs.microsoft.com/visualstudio/deployment/walkthrough-creating-a-custom-bootstrapper-to-show-a-privacy-prompt).  
