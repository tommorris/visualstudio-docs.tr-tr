...
ms.locfileid: "42628765"
---
# <a name="l2dbformxaml-source-code"></a>L2DBForm.XAML kaynak kodu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [L2DBForm.xaml kaynak kodu](https://docs.microsoft.com/visualstudio/designers/l2dbform-xaml-source-code).  
