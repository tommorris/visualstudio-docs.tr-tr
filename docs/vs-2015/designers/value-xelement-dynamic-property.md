...
ms.locfileid: "42695387"
---
# <a name="value-xelement-dynamic-property"></a>Değer (XElement dinamik özelliği)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [değer (XElement dinamik özelliği)](https://docs.microsoft.com/visualstudio/designers/value-xelement-dynamic-property).  
