...
ms.locfileid: "42684273"
---
# <a name="xml-xelement-dynamic-property"></a>XML (XElement dinamik özelliği)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [Xml (XElement dinamik özelliği)](https://docs.microsoft.com/visualstudio/designers/xml-xelement-dynamic-property).  
