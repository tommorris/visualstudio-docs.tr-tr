...
ms.locfileid: "42697491"
---
# <a name="adding-search-to-a-tool-window"></a>Araç Penceresine Arama Ekleme
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [araç penceresine arama ekleme](https://docs.microsoft.com/visualstudio/extensibility/adding-search-to-a-tool-window).  
