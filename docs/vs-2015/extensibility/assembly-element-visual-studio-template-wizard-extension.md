...
Bu konuda en son sürümünü şu yolda bulunabilir: [Assembly öğesi (Visual Studio Şablon Sihirbazı uzantısı)](https://docs.microsoft.com/visualstudio/extensibility/assembly-element-visual-studio-template-wizard-extension).  
