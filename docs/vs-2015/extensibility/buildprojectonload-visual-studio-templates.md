...
ms.locfileid: "42693231"
---
# <a name="buildprojectonload-visual-studio-templates"></a>BuildProjectOnLoad (Visual Studio Şablonları)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [BuildProjectOnLoad (Visual Studio şablonları)](https://docs.microsoft.com/visualstudio/extensibility/buildprojectonload-visual-studio-templates).  
