...
ms.locfileid: "42687258"
---
# <a name="command-flag-element"></a>Command Flag Öğesi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [Command Flag öğesi](https://docs.microsoft.com/visualstudio/extensibility/command-flag-element).  
