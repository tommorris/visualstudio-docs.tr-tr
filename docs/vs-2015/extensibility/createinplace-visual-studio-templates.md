...
ms.locfileid: "42695231"
---
# <a name="createinplace-visual-studio-templates"></a>CreateInPlace (Visual Studio Şablonları)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [Createınplace (Visual Studio şablonları)](https://docs.microsoft.com/visualstudio/extensibility/createinplace-visual-studio-templates).  
