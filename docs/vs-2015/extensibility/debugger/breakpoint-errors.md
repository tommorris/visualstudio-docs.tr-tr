...
ms.locfileid: "42682400"
---
# <a name="breakpoint-errors"></a>Kesme Noktası Hataları
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [kesme noktası hataları](https://docs.microsoft.com/visualstudio/extensibility/debugger/breakpoint-errors).  
