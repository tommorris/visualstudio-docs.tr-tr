...
ms.locfileid: "42691155"
---
# <a name="enumerating-locals"></a>Yerel Öğeleri Numaralandırma
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [yerel öğeleri numaralandırma](https://docs.microsoft.com/visualstudio/extensibility/debugger/enumerating-locals).  
