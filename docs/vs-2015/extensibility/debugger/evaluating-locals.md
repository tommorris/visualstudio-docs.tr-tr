...
ms.locfileid: "42691944"
---
# <a name="evaluating-locals"></a>Yerel Öğeleri Değerlendirme
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [yerel öğeleri değerlendirme](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
