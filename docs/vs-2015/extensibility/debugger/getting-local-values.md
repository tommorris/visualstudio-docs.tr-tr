...
ms.locfileid: "42632502"
---
# <a name="getting-local-values"></a>Yerel Değerleri Alma
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [yerel değerleri alma](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-values).  
