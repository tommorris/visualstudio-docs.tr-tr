...
Bu konuda en son sürümünü şu yolda bulunabilir: [IDebugPendingBreakpoint2::EnumErrorBreakpoints](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugpendingbreakpoint2-enumerrorbreakpoints).  
