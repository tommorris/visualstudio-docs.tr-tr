...
Bu konuda en son sürümünü şu yolda bulunabilir: [IDebugPortSupplier2::RemovePort](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugportsupplier2-removeport).  
