...
Bu konuda en son sürümünü şu yolda bulunabilir: [IDebugProgramNode2::GetHostName](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugprogramnode2-gethostname).  
