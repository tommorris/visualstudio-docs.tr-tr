...
Bu konuda en son sürümünü şu yolda bulunabilir: [IDebugThread2::GetLogicalThread](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugthread2-getlogicalthread).  
