...
#### <a name="parameters"></a>Parametreler  
 ...
 `ptp`  
 [out içinde] A [THREADPROPERTIES](../../../extensibility/debugger/reference/threadproperties.md) yapısı, iş parçacığının özellikleri ile doldurulur.  
