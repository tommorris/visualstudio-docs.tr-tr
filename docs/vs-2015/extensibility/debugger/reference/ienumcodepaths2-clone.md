...
ms.locfileid: "42690382"
---
# <a name="ienumcodepaths2clone"></a>IEnumCodePaths2::Clone
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [IEnumCodePaths2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-clone).  
