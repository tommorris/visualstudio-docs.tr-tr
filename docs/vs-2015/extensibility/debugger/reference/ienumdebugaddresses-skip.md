...
Bu konuda en son sürümünü şu yolda bulunabilir: [IEnumDebugAddresses::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugaddresses-skip).  
