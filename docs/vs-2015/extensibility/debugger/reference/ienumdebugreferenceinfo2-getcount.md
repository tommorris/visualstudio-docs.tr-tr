...
Bu konuda en son sürümünü şu yolda bulunabilir: [IEnumDebugReferenceInfo2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugreferenceinfo2-getcount).  
