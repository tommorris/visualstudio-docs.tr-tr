...
ms.locfileid: "42694362"
---
# <a name="taskstateexecuted-field"></a>TASK_STATE_EXECUTED Alanı
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [TASK_STATE_EXECUTED alanı](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-executed-field).  
