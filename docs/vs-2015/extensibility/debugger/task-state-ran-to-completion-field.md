...
ms.locfileid: "42630203"
---
# <a name="taskstaterantocompletion-field"></a>TASK_STATE_RAN_TO_COMPLETION Alanı
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [task_state_ran_to_completıon alanı](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-ran-to-completion-field).  
