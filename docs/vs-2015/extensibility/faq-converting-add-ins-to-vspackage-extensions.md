...
Bu konuda en son sürümünü şu yolda bulunabilir: [SSS: eklentileri VSPackage uzantılarına dönüştürme](https://docs.microsoft.com/visualstudio/extensibility/faq-converting-add-ins-to-vspackage-extensions).  
