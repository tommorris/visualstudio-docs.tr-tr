...
ms.locfileid: "42631699"
---
# <a name="hidden-element-visual-studio-templates"></a>Hidden Öğesi (Visual Studio Öğe Şablonları)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [gizli öğesi (Visual Studio şablonları)](https://docs.microsoft.com/visualstudio/extensibility/hidden-element-visual-studio-templates).  
