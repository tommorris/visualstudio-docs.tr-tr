...
ms.locfileid: "42632736"
---
# <a name="how-to-implement-nested-projects"></a>Nasıl yapılır: iç içe Projeler uygulama
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [nasıl yapılır: uygulama iç içe projeler](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-implement-nested-projects).  
