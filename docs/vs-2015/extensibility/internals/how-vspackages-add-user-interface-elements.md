...
ms.locfileid: "42697201"
---
# <a name="how-vspackages-add-user-interface-elements"></a>VSPackage’ların Kullanıcı Arabirimi Öğeleri Eklemesi
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [nasıl VSPackages Ekle kullanıcı arabirimi öğeleri](https://docs.microsoft.com/visualstudio/extensibility/internals/how-vspackages-add-user-interface-elements).  
