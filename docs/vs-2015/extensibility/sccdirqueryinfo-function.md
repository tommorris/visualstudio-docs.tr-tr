...
ms.locfileid: "42689593"
---
# <a name="sccdirqueryinfo-function"></a>SccDirQueryInfo İşlevi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [Sccdirqueryınfo işlevi](https://docs.microsoft.com/visualstudio/extensibility/sccdirqueryinfo-function).  
