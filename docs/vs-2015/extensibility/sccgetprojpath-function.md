...
ms.locfileid: "42632135"
---
# <a name="sccgetprojpath-function"></a>SccGetProjPath İşlevi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [SccGetProjPath işlevi](https://docs.microsoft.com/visualstudio/extensibility/sccgetprojpath-function).  
