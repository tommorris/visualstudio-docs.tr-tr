...
Bu konuda en son sürümünü şu yolda bulunabilir: [sık kullanılan komutlar Visual Studio için varsayılan klavye kısayolları](https://docs.microsoft.com/visualstudio/ide/default-keyboard-shortcuts-for-frequently-used-commands-in-visual-studio).  
