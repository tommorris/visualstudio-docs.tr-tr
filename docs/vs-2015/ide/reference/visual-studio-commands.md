...
ms.locfileid: "42693853"
---
# <a name="visual-studio-commands"></a>Visual Studio Komutları
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [Visual Studio komutları](https://docs.microsoft.com/visualstudio/ide/reference/visual-studio-commands).  
