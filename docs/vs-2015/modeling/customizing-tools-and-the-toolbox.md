...
ms.locfileid: "42634356"
---
# <a name="customizing-tools-and-the-toolbox"></a>Araçları ve Araç Kutusunu Özelleştirme
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [özelleştirme araçları ve araç kutusunu](https://docs.microsoft.com/visualstudio/modeling/customizing-tools-and-the-toolbox).  
