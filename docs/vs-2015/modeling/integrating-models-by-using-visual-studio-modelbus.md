...
Bu konuda en son sürümünü şu yolda bulunabilir: [Visual Studio Modelbus kullanarak modelleri tümleştirme](https://docs.microsoft.com/visualstudio/modeling/integrating-models-by-using-visual-studio-modelbus).  
