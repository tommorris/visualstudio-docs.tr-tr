...
Bu konuda en son sürümünü şu yolda bulunabilir: [izlenecek yol: bir modeli erişen metin şablonunda hata ayıklama](https://docs.microsoft.com/visualstudio/modeling/walkthrough-debugging-a-text-template-that-accesses-a-model).  
