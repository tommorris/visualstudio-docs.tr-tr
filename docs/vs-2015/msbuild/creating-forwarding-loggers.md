...
ms.locfileid: "42684256"
---
# <a name="creating-forwarding-loggers"></a>İletme Günlükçüleri Oluşturma
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [iletme Günlükçüleri oluşturma](https://docs.microsoft.com/visualstudio/msbuild/creating-forwarding-loggers).  
