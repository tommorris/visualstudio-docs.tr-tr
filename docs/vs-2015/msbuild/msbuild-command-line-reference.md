...
ms.locfileid: "42687412"
---
# <a name="msbuild-command-line-reference"></a>MSBuild Komut Satırı Başvurusu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [MSBuild komut satırı başvurusu](https://docs.microsoft.com/visualstudio/msbuild/msbuild-command-line-reference).  
