...
Bu konuda en son sürümünü şu yolda bulunabilir: [izlenecek yol: sıfırdan bir MSBuild proje dosyası oluşturma](https://docs.microsoft.com/visualstudio/msbuild/walkthrough-creating-an-msbuild-project-file-from-scratch).  
