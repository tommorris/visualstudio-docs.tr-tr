...
ms.locfileid: "42694666"
---
# <a name="walkthrough-using-msbuild"></a>İzlenecek Yol: MSBuild Kullanma
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [izlenecek yol: MSBuild kullanma](https://docs.microsoft.com/visualstudio/msbuild/walkthrough-using-msbuild).  
