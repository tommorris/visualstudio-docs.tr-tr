...
ms.locfileid: "42689865"
---
# <a name="markerserieswriteflag-method"></a>marker_series::write_flag Yöntemi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [marker_series::write_flag yöntemi](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-flag-method).  
