...
ms.locfileid: "42691240"
---
# <a name="threads-view-parallel-performance"></a>İş Parçacıkları Görünümü (Paralel Performans)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [iş parçacıkları görünümü (paralel performans)](https://docs.microsoft.com/visualstudio/profiling/threads-view-parallel-performance).  
