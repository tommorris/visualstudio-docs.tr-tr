...
ms.locfileid: "42691380"
---
# <a name="sample-xsd-file-purchase-order-schema"></a>Örnek XSD dosyası: Satın alma siparişi şeması
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [örnek XSD dosyası: satın alma siparişi şeması](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-purchase-order-schema).  
