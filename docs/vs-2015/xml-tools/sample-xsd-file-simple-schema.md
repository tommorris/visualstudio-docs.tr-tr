...
ms.locfileid: "42686257"
---
# <a name="sample-xsd-file-simple-schema"></a>Örnek XSD dosyası: Basit şema
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Bu konuda en son sürümünü şu yolda bulunabilir: [örnek XSD dosyası: Basit şema](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-simple-schema).  
