...
|VSTO eklentileri|Excel<br /><br /> InfoPath (InfoPath 2013 ve InfoPath 2010 yalnızca)<br /><br /> Outlook<br /><br /> PowerPoint<br /><br /> Project<br /><br /> Visio<br /><br /> Word<br /><br /> Excel|  
...
|ClickOnce dağıtımı.|VS ve belge düzeyi projelerine.|[Office çözümü dağıtma](../vsto/deploying-an-office-solution.md)|  
