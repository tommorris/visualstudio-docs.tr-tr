...
# <a name="how-to-add-namedrange-controls-to-worksheets"></a>Nasıl yapılır: çalışma sayfalarına NamedRange denetimleri ekleme
 ...
 Ayrıca ekleyebileceğiniz <xref:Microsoft.Office.Tools.Excel.NamedRange> denetimlerini çalışma zamanında VSTO eklentisi projelerine.  
...
-   [Çalışma zamanında VSTO eklenti projesindeki NamedRange denetimleri ekleme](#runtimeaddin)  
...
2.  İçinde **adı kutusuna**, basın ve aralığı için bir ad yazın **Enter**.  
