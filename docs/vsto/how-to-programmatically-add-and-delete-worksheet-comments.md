---
title: 'Nasıl yapılır: program aracılığıyla ekleyin ve çalışma sayfası Açıklamaları Sil'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35255492"
---
# <a name="how-to-programmatically-add-and-delete-worksheet-comments"></a>Nasıl yapılır: program aracılığıyla ekleyin ve çalışma sayfası Açıklamaları Sil
...
## <a name="add-and-delete-a-comment-in-a-document-level-project"></a>Ekleme ve bir açıklama belge düzeyi projede silme  
...
## <a name="add-and-delete-a-comment-in-an-vsto-add-in-project"></a>Ekleme ve bir açıklama VSTO eklenti projesindeki silme  
