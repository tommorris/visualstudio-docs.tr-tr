---
title: 'Nasıl yapılır: belgelerde metne program aracılığıyla açıklamaları ekleme'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35255050"
---
# <a name="how-to-programmatically-add-comments-to-text-in-documents"></a>Nasıl yapılır: belgelerde metne program aracılığıyla açıklamaları ekleme
