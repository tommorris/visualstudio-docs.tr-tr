---
title: "Nasıl yapılır: program aracılığıyla Outlook e-posta öğelerinden ekleri kaydetme | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
> [!IMPORTANT]  
>  Bu örnek yalnızca adlı bir klasör eklerseniz çalışır **TestFileSave** C dizininin kökündeki.  
