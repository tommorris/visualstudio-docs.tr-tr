---
title: "Microsoft Office Excel Klavyesi, Microsoft Office Klavyesi ayarları, Seçenekler iletişim kutusu | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
 ...
 **Visual Studio klavye düzeni**  
 Excel odağa sahip olsa bile tüm kısayol tuşu komutlarını, visual Studio alır. Örneğin, Excel odağa sahipken F5 işlev tuşuna basarsanız, Visual Studio çözümünüzü hata ayıklama başlatır.  
