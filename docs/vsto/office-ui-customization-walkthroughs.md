...
## <a name="controls-on-word-documents"></a>Word belgeleri denetimleri  
 [İzlenecek yol: bir belgeyi içinde bir VSTO eklenti çalışma zamanında denetimler ekleme](../vsto/walkthrough-adding-controls-to-a-document-at-run-time-in-a-vsto-add-in.md)  
