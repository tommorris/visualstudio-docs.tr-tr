---
title: İş Akışı Tasarımcısı - eski iş akışı projeleri oluşturma
ms.date: 11/04/2016
ms.topic: reference
...
Bu bölümde, Visual Studio 2010 tarafından sağlanan eski Windows iş akışı Tasarımcısı kullanarak iş akışı projeleri oluşturmayı açıklar. .NET Framework sürüm 3.5 veya WinFX eski iş akışı Tasarımcısı hedefler. Aşağıdaki tabloda listelenen iş akışı proje şablonları kullanma hakkında bilgi içerir.
