...
[!INCLUDE[vs2010](../misc/includes/vs2010_md.md)]sağlar [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] oluşturmak için [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)] hedefleyen uygulamalar [!INCLUDE[netfx40_long](../workflow-designer/includes/netfx40_long_md.md)]. Bilinen Tasarımcısı kullanır [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] grafik oluşturma ve iş akışı uygulamalarının hata ayıklama için kullanıcı arabirimi.  
