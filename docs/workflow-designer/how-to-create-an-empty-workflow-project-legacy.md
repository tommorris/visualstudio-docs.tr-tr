---
title: 'İş Akışı Tasarımcısı - nasıl yapılır: bir boş iş akışı projesi (eski) oluşturun'
ms.date: 11/04/2016
ms.topic: conceptual
...
Visual Studio 2010 tarafından sağlanan eski Windows iş akışı Tasarımcısı kullanarak boş bir iş akışı projesi oluşturmak için aşağıdaki adımları izleyin. .NET Framework sürüm 3.5 veya WinFX hedeflemek gerektiğinde eski iş akışı Tasarımcısı kullanın.

## <a name="to-create-an-empty-workflow-project"></a>Bir boş iş akışı projesi oluşturmak için
...
5.  İçinde **şablonları** bölmesinde, **boş iş akışı projesinde**.
