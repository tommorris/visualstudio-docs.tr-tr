...
3.  Bulma sonucu gösterildiği [!INCLUDE[vs_current_short](../code-quality/includes/vs_current_short_md.md)] **Bul sonuç** görünümü. Sonuç öğeyi çift iş akışı Tasarımcısı'nda eşleşme içeren etkinlik gider.