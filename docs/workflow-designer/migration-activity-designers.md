...
Geçiş etkinlik tasarımcıları, .NET Framework 4 hedefleyen bir iş akışından 3.0/3.5 etkinlikleri iş akışının çağırmak için kullanılır. Bu bölümde yer alan konular, iş akışı Tasarımcısı etkinlik tasarımcıları kullanma hakkında yönergeler sağlar.
