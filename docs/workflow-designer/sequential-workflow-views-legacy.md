...
[!INCLUDE[vs2010](../misc/includes/vs2010_md.md)]eski sağlar [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] kullanılabilecek hedef [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] veya [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)].  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [Aktivite görünümleri (eski)](../workflow-designer/activity-views-legacy.md)   
