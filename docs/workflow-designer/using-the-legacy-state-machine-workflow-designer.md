...
|------------------|--------------|-----------------|
|**Durum**|[StateActivity](http://go.microsoft.com/fwlink?LinkID=65042)|Durum makinesinin durumda temsil eder; Ek içeren **buraya StateActivity** etkinlikler. Daha fazla bilgi için bkz: [kullanarak buraya StateActivity etkinliğini](http://go.microsoft.com/fwlink?LinkID=65083).|
