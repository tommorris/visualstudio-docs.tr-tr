...
|Windows hata ayıklama|Windows, hata ayıklama gibi standart Visual Studio **iş parçacığı**, **çağrı yığını**, **kesme noktası**, **Yereller aracı**ve **İzleme aracı** windows.|  
