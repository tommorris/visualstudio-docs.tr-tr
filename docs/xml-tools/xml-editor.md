...
## <a name="express-editions"></a>Express sürümleri  
 Aşağıdaki XML Düzenleyicisi özellikler Visual Studio Express sürümlerinde kullanılabilir değildir:  
  
-   Bir XML şeması bir XML örneği belgesinden oluşturuluyor.  
  
-   XSLT çıktı XML Düzenleyicisi'nden görüntüleme.  
  
-   XSLT stil sayfaları düzenlerken akıllı doğrulama.  
...
## <a name="related-sections"></a>İlgili Bölümler  
 [Metin, kod ve biçimlendirme düzenleme](http://msdn.microsoft.com/en-us/0d9c00d7-5df4-48a3-b185-2a265f055439)  
