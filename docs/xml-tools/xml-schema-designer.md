...
## <a name="in-this-section"></a>Bu Bölümde  
 ...
 XML şema Gezgini ve nasıl XML Şeması Tanım Dili (XSD) şemalarda çalışmanıza olanak sağlayan bir bakış sağlar.  
 ...
 XML şema Tasarımcısı XML Düzenleyicisi ile nasıl tümleştirildiği açıklar.  
