---
title: "JsCreateReferenceError işlevi | Microsoft Docs"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="jscreatereferenceerror-function"></a>JsCreateReferenceError İşlevi
Yeni bir JavaScript ReferenceError hata nesnesi oluşturur  
