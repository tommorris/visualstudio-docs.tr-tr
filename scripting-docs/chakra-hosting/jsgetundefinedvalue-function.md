---
title: "JsGetUndefinedValue işlevi | Microsoft Docs"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="jsgetundefinedvalue-function"></a>JsGetUndefinedValue İşlevi
Değerini alır `undefined` geçerli betik bağlamındaki.  
