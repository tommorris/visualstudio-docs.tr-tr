...
Bu sayfa, JavaScript, TypeScript ve diğer ECMAScript tabanlı teknolojiler için bağlantılar sağlar.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Komut dosyası arabirimleri Windows hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
