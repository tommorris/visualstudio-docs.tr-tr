---
title: buffer özelliği (Uint8ClampedArray) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24788948"
---
# <a name="buffer-property-uint8clampedarray"></a>buffer özelliği (Uint8ClampedArray)
Salt okunur. Alır [ArrayBuffer](../../javascript/reference/arraybuffer-object.md) bu dizisi tarafından başvurulan.  
