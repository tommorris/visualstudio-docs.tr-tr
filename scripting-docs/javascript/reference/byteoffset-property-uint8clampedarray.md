---
title: byteOffset özelliği (Uint8ClampedArray) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24788966"
---
# <a name="byteoffset-property-uint8clampedarray"></a>byteOffset özelliği (Uint8ClampedArray)
Salt okunur. Bu dizinin başından uzaklık kendi [ArrayBuffer](../../javascript/reference/arraybuffer-object.md), oluşturma zamanında sabit olarak bayt cinsinden.  
