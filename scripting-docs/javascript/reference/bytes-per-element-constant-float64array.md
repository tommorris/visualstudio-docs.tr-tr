---
title: BYTES_PER_ELEMENT sabiti (Float64Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24789101"
---
# <a name="bytesperelement-constant-float64array"></a>BYTES_PER_ELEMENT Sabiti (Float64Array)
