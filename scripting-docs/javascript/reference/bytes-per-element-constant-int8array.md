---
title: BYTES_PER_ELEMENT sabiti (ınt8array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24789038"
---
# <a name="bytesperelement-constant-int8array"></a>BYTES_PER_ELEMENT Sabiti (Int8Array)
