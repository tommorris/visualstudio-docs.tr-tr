---
title: constructor özelliği (WeakSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790349"
---
# <a name="constructor-property-weakset"></a>constructor Özelliği (WeakSet)
Oluşturur işlevini belirten bir `WeakSet`.  
