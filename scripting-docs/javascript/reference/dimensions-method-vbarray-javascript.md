---
title: dimensions yöntemi (VBArray) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790586"
---
# <a name="dimensions-method-vbarray-javascript"></a>dimensions Yöntemi (VBArray) (JavaScript)
Bir VBArray boyut sayısını döndürür.  
...
## <a name="remarks"></a>Açıklamalar  
 Gerekli *dizi* VBArray nesnesi.  
  
## <a name="example"></a>Örnek  
 **Boyutları** yöntemi belirtilen VBArray boyutlarında sayısını almak için bir yol sağlar.  
