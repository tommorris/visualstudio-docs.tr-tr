---
title: length özelliği (Uint8ClampedArray) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791099"
---
# <a name="length-property-uint8clampedarray"></a>length özelliği (Uint8ClampedArray)
Dizinin uzunluğu.  
