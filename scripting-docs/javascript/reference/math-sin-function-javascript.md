---
title: Math.sin işlevi (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791066"
---
# <a name="mathsin-function-javascript"></a>Math.sin İşlevi (JavaScript)
Bir sayının sinüsünü döndürür.  
...
## <a name="remarks"></a>Açıklamalar  
 `radians` Radyan cinsinden ölçülen açı içeren sayısal bir ifade bağımsız değişkeni aşağıdaki gibidir.  
  
 Dönüş değeri sayısal bağımsız değişkeni sinüsünü değeridir.  
