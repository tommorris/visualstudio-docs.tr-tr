---
title: Çarpma işleci (*) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791030"
---
# <a name="multiplication-operator--javascript"></a>Çarpma İşleci (*) (JavaScript)
İki ifadeye değerle çarpar.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [Çarpma atama işleci (* =)](../../javascript/reference/multiplication-assignment-operator-decrement-equal-javascript.md)   
