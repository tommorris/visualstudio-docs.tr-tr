---
title: Object.getPrototypeOf işlevi (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791153"
---
# <a name="objectgetprototypeof-function-javascript"></a>Object.getPrototypeOf İşlevi (JavaScript)
Bir nesne örneğini döndürür.  
...
#### <a name="parameters"></a>Parametreler  
 `object`  
 Gerekli. Prototip başvuran nesne.  
  
## <a name="return-value"></a>Dönüş Değeri  
 Prototipi `object` bağımsız değişkeni. Prototip ayrıca bir nesnedir.  
  
## <a name="exceptions"></a>Özel Durumlar  
 Varsa `object` bağımsız değişkeni bir nesne değil bir `TypeError` özel durumu oluşur.  
  
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanımını göstermektedir `Object.getPrototypeOf` işlevi.  
...
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanır `Object.getPrototypeOf` veri türleri doğrulamak için işlev.  
