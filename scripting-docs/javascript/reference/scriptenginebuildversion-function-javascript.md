---
title: ScriptEngineBuildVersion işlevi (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791516"
---
# <a name="scriptenginebuildversion-function-javascript"></a>ScriptEngineBuildVersion İşlevi (JavaScript)
Komut dosyası altyapısı yapı sürüm numarasını kullanımda alır.  
...
## <a name="example"></a>Örnek  
 Aşağıdaki örnek kullanımını göstermektedir `ScriptEngineBuildVersion` işlevi:  
