---
title: Çıkarma atama işleci (-) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791567"
---
# <a name="subtraction-assignment-operator---javascript"></a>Çıkarma Atama İşleci (-=) (JavaScript)
Değerinden bir ifadenin bir değişkenin değerini çıkarır ve sonuç değişkenine atar.  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 [Çıkarma işleci (-)](../../javascript/reference/subtraction-operator-decrement-javascript.md)   
