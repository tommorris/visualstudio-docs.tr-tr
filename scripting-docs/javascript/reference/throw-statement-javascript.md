---
title: throw deyimi (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791387"
---
# <a name="throw-statement-javascript"></a>throw Deyimi (JavaScript)
Tarafından işlenen bir hata koşulu oluşturan bir `try...catch...finally` deyimi.  
...
## <a name="remarks"></a>Açıklamalar  
 Gerekli `exception` bağımsız değişkeni, herhangi bir ifade olabilir.  
  
 Aşağıdaki örnek içinde bir hata oluşturur bir `try` bloğu ve yakalanan `catch` bloğu.  
