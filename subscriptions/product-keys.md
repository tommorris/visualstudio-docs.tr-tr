...
Tüm kullanılabilir ürün anahtarları aboneliğinizde talep ve tüm kullanılabilir kullanılan etkinleştirmeler, yerel Visual Studio aboneliğiniz ile iletişim kurarak ek anahtarlar isteyebilir [Müşteri Hizmetleri Merkezi](https://visualstudio.microsoft.com/subscriptions/support/). Bir olay temelinde istekleri kabul edilir. Onaylanırsa, ürün anahtarlarını erişilebilen [indirmeleri](https://my.visualstudio.com/downloads).
...
Aboneliğinize bir 24 saatlik süre içinde anahtarları kullanılabilir en fazla sayısını talep sınıra ulaşıldı bildiren bir hata görürsünüz. 00:01:00 başlayarak her 24 saatte sınırı sıfırlar Pasifik saati.

Bizim araştırma çoğu aboneleri kendi aboneliğine dahil ürün anahtarları sayısı tarafından kapsanan gösterir. Bir ek anahtar gerekiyorsa, Visual Studio abonelik aracılığıyla bir istek gönderebilir [Müşteri Hizmetleri](https://visualstudio.microsoft.com/subscriptions/support/) ve onay olay olarak kabul edilir.
