---
title: Veri bilimi yeteneklerinizi bugün seçili Visual Studio Aboneliklerde DataCamp avantajı ile geliştirin. | Microsoft Docs
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 01/12/20108
...
Uygun Visual Studio abonelikleri DataCamp abonelikleri içerir.  DataCamp ile tarayıcınız rahatlık gereksinim duyduğunuz tüm veri bilimi yetenekleri öğrenebilirsiniz. Ne zaman ve ne öğrenin seçin alın. Yüklemek için herhangi bir yazılım ve özel bir donanım gereksinimi, veri bilimi öğrenme zamankinden daha kolay olur.
...
Herhangi bir noktada durdurmak ve eğitim sonraki oturumunuzda sürdürün.  Yalnızca ziyaret [ http://www.datacamp.com ](http://www.datacamp.com)ve oturum açın.  Burada, duraklatıldı eğitim hak devam edebilirsiniz ve panonuz göreceksiniz. Tıklamanız yeterlidir **devam izleme**. ![DataCamp devam eğitim](_img\vs-datacamp\vs-datacamp-continue-training.png)

## <a name="eligibility"></a>Uygunluk

| Abonelik düzeyi                                                 |     Kanallar                                            | Faydası                                                          | Yenilenebilir?    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (standart, yıllık bulut)   | Toplu Lisans, Azure, perakende, | 3 ay       |  Hayır.  Yalnızca yeni aboneler          |
| Visual Studio Professional (standart, yıllık bulut) | Toplu Lisans, Azure, perakende                                       | 3 ay                                                            |  Hayır.  Yalnızca yeni aboneler           |
| Visual Studio Test uzmanı (standart)                         | Toplu Lisans, perakende                                              | Kullanılabilir                                             |  Hayır.  Yalnızca yeni aboneler           |
| MSDN platformları (standart)                                          | Toplu Lisans, perakende                                              | Kullanılabilir                                              |  Hayır.  Yalnızca yeni aboneler           |
| Visual Studio Dev Essentials | Yok  | 2 ay | Hayır. Yalnızca yeni aboneler |
