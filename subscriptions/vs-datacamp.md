---
title: "Veri bilimi yeteneklerinizi Bugün, Visual Studio aboneliğinizdeki DataCamp avantajı etkinleştirerek geliştirin."
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 11/15/2017
...
| Abonelik                                                     | DataCamp avantajı              |
|------------------------------------------------------------------|----------------------|
| Visual Studio Enterprise standart & yıllık abonelikler   | 3 aylık abonelik |
| Visual Studio Professional standart & yıllık abonelikler | 3 aylık abonelik |
| Visual Studio geliştirme temelleri                                     | 2 aylık abonelik |

**Not:** Visual Studio aboneliklerle dahil DataCamp hub yalnızca yeni DataCamp abonelere avantajdır. 

## <a name="activating-your-datacamp-subscription-is-fast-and-easy"></a>DataCamp aboneliğinizi etkinleştirme hızlı ve kolay olur.  

1. Oturum [https://my.visualstudio.com](https://my.visualstudio.com).
