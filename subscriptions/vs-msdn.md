---
title: Visual Studio Aboneliklerde MSDN dergisi avantajı | Microsoft Docs
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 01/13/2018
...
### <a name="printed-edition"></a>Yazdırılan edition
1.  MSDN dergisi aboneliğinizi almaya başlamak için oturum açın [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs)
2.  MSDN dergisi döşeme Professional geliştirme bölümünde bulun ve tıklayın **abone ol** MSDN dergisi abonelik kutucuğuna. (Tıklayın "!" dijital edition erişmek için kutucuğun alt sağ köşesindeki.)
...
4.  İstenen kişi bilgilerini sağlayın ve tıklayın **gönderme**.  (Seçtiğiniz dergisi sürümü dergi abonelik bölümünde görüntülenir.  Yazdırılan sürümü seçerseniz, ilk seçenek okuma yapacak **Evet!  1 yıl (12 sorunları) MSDN dergisi ücretsiz almak istediğiniz**.)

    ![MSDN dergisi avantajı profili](_img\vs-msdn\vs-msdn-profile.png)

5.  Tüm olan İşte bu kadar.  Seçtiğiniz dergisi sürümüne bağlı olarak, yazdırılan dergi veya sonraki sürümü ile en son çevrimiçi sürümleri için bağlantılar ile e-postaları almak ya da başlarsınız.  Keyfini çıkarın!

## <a name="eligibility"></a>Uygunluk
| Abonelik düzeyi                                                 |     Kanallar                                            | Faydası                                                          | Yenilenebilir?    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (standart, yıllık bulut)   | Toplu Lisans, Azure, perakende, seçili NFR<sup>1</sup> |Yazdırılan edition       |  Hayır.  Yalnızca yeni aboneler          |
| Visual Studio Professional (standart, yıllık bulut) | Toplu Lisans, Azure, perakende                                       | Yazdırılan edition                                                            |Hayır.  Yalnızca yeni aboneler         |
| Visual Studio Test uzmanı (standart)                         | Toplu Lisans, perakende                                              | Yazdırılan edition                                             |  Hayır.  Yalnızca yeni aboneler         |
| MSDN platformları (standart)                                          | Toplu Lisans, perakende                                              | Yazdırılan edition                                              | Hayır.  Yalnızca yeni aboneler         |
